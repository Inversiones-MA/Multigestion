                                    ...
                                    <div class="row">
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td class="auto-style1">
                                                        <asp:Button ID="btnGuardar6" CssClass="btn btn-primary btn-info pull-right" runat="server" Text="Guardar" OnClick="btnGuardar_Click" OnClientClick="return Dialogo();" />
