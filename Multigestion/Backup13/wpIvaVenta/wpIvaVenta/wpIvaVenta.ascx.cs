    ...
    {        
        ...
        protected void btnFinalizarAct_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["IDIVAVENTAS"] != null)
            {
                ...
                {
                    exito = MTO.finalizarIvaVENTAS(objresumen.idEmpresa.ToString(), ViewState["IDIVAVENTAS"].ToString(), xmlData, Constantes.RIESGO.VALIDACION, (DateTime.Now.Year).ToString());
                    pnFormularioAct.Enabled = false;
                    llenargrid();
                }
                else
        ...
        protected void btnFinalizar1_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["IDIVAVENTAS"] != null)
            {
                ...
                if (mensaje == string.Empty)
                {
                    exito = MTO.finalizarIvaVENTAS(objresumen.idEmpresa.ToString(), ViewState["IDIVAVENTAS"].ToString(), xmlData, Constantes.RIESGO.VALIDACION, (DateTime.Now.Year - 1).ToString());
                    pnFormularioAct.Enabled = false;
                    llenargrid();
                }
                else
        ...
        protected void btnFinalizar2_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["IDIVAVENTAS"] != null)
            {
                ...
                if (mensaje == string.Empty)
                {
                    exito = MTO.finalizarIvaVENTAS(objresumen.idEmpresa.ToString(), ViewState["IDIVAVENTAS"].ToString(), xmlData, Constantes.RIESGO.VALIDACION, (DateTime.Now.Year - 2).ToString());
                    pnFormularioAct.Enabled = false;
                    llenargrid();
                }
                else
        ...
        protected void btnFinalizar3_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["IDIVAVENTAS"] != null)
            {
                ...
                if (mensaje == string.Empty)
                {
                    exito = MTO.finalizarIvaVENTAS(objresumen.idEmpresa.ToString(), ViewState["IDIVAVENTAS"].ToString(), xmlData, Constantes.RIESGO.VALIDACION, (DateTime.Now.Year - 3).ToString());
                    pnFormularioAct.Enabled = false;
                    llenargrid();
                }
                else
        ...
        private void llenargrid()
        {
            ...
            ViewState["res1"] = MTO.ListarIVAVentas(objresumen.idEmpresa, DateTime.Now.Year, Constantes.DOCUMENTOSCONTABLE.IVAVENTAS);
            ViewState["res2"] = MTO.ListarIVAVentas(objresumen.idEmpresa, DateTime.Now.Year - 1, Constantes.DOCUMENTOSCONTABLE.IVAVENTAS);
            ViewState["res3"] = MTO.ListarIVAVentas(objresumen.idEmpresa, DateTime.Now.Year - 2, Constantes.DOCUMENTOSCONTABLE.IVAVENTAS);
            ViewState["res4"] = MTO.ListarIVAVentas(objresumen.idEmpresa, DateTime.Now.Year - 3, Constantes.DOCUMENTOSCONTABLE.IVAVENTAS);
        ...
        protected void guardarAct()
        {
            ...
            {
                exito = MTO.InsertarIvaVENTAS(objresumen.idEmpresa.ToString(), generarXML((DateTime.Now.Year).ToString(), ref gridIvaAct), (DateTime.Now.Year).ToString());
                if (exito)
                {
                    ocultarDiv();
            ...
            {
                exito = MTO.ModificarIvaVENTAS(objresumen.idEmpresa.ToString(), ViewState["IDIVAVENTAS"].ToString(), generarXML((DateTime.Now.Year).ToString(), ref gridIvaAct), (DateTime.Now.Year).ToString());
                if (exito)
                {
                    ocultarDiv();
                    dvSuccess.Style.Add("display", "block");
        ...
        protected void guardar1()
        {
            ...
            if (ViewState["ACCION"].ToString() == Constantes.OPCION.INSERTAR)
            {
                exito = MTO.InsertarIvaVENTAS(objresumen.idEmpresa.ToString(), generarXML((DateTime.Now.Year - 1).ToString(), ref gridIva1), (DateTime.Now.Year - 1).ToString());
                if (exito)
                {
                    ocultarDiv();
                    dvSuccess.Style.Add("display", "block");
            ...
            {
                exito = MTO.ModificarIvaVENTAS(objresumen.idEmpresa.ToString(), ViewState["IDIVAVENTAS"].ToString(), generarXML((DateTime.Now.Year - 1).ToString(), ref gridIva1), (DateTime.Now.Year - 1).ToString());
                if (exito)
                {
                    ocultarDiv();
                    dvSuccess.Style.Add("display", "block");
        ...
        protected void guardar3()
        {
            ...
            if (ViewState["ACCION"].ToString() == Constantes.OPCION.INSERTAR)
            {
                exito = MTO.InsertarIvaVENTAS(objresumen.idEmpresa.ToString(), generarXML((DateTime.Now.Year - 2).ToString(), ref gridIva2), (DateTime.Now.Year - 2).ToString());
                if (exito)
                {
                    ocultarDiv();
                    dvSuccess.Style.Add("display", "block");
            ...
            {
                exito = MTO.ModificarIvaVENTAS(objresumen.idEmpresa.ToString(), ViewState["IDIVAVENTAS"].ToString(), generarXML((DateTime.Now.Year - 2).ToString(), ref gridIva2), (DateTime.Now.Year - 2).ToString());
                if (exito)
                {
                    ocultarDiv();
                    dvSuccess.Style.Add("display", "block");
        ...
        protected void guardar4()
        {
            ...
            if (ViewState["ACCION"].ToString() == Constantes.OPCION.INSERTAR)
            {
                exito = MTO.InsertarIvaVENTAS(objresumen.idEmpresa.ToString(), generarXML((DateTime.Now.Year - 3).ToString(), ref gridIva3), (DateTime.Now.Year - 3).ToString());
                if (exito)
                {
                    ocultarDiv();
                    dvSuccess.Style.Add("display", "block");
            ...
            {
                exito = MTO.ModificarIvaVENTAS(objresumen.idEmpresa.ToString(), ViewState["IDIVAVENTAS"].ToString(), generarXML((DateTime.Now.Year - 3).ToString(), ref gridIva3), (DateTime.Now.Year - 3).ToString());
                if (exito)
                {
                    ocultarDiv();
                    dvSuccess.Style.Add("display", "block");
