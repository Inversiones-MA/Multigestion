...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpDirectorio.ascx.cs" Inherits="MultiComercial.wpDirectorio.wpDirectorio.wpDirectorio" %>


<script type="text/javascript" src="../../_layouts/15/MultiComercial/wpDirectorio.js"></script>
    ...
    <div class="row clearfix">
        <div class="col-md-6 column">
            <div class="btn-group btn-breadcrumb">
                ...
                <a class="btn btn-info sinMargen">Directorio</a>
            </div>
        </div>
                        ...
                        <asp:Panel ID="pnFormulario" runat="server">
                            <div class="form-horizontal" role="form">
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="col-sm-7">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>&nbsp;</td>
                                                    <td>
                                                        <asp:TextBox ID="txt_divRut" runat="server" MaxLength="1" CssClass="form-control" Width="30px"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-5 control-label">Antiguedad</label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txt_antiguedad" runat="server" MaxLength="3" CssClass="form-control" onKeyPress="return solonumeros(event)"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <!-- Grupo 2 -->
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-5 control-label">Profesión</label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txt_profesion" runat="server" CssClass="form-control" MaxLength="50"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-5 control-label">Universidad:</label>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txt_universidad" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
