...
namespace MultiComercial.wpListarComercial.wpListarComercial {
    ...
    public partial class wpListarComercial {
        ...
        public static implicit operator global::System.Web.UI.TemplateControl(wpListarComercial target) 
        {
        ...
        private global::System.Web.UI.WebControls.Panel @__BuildControlPanel1() {
            ...
            @__ctrl1 = this.@__BuildControldv_buscarEmpresas();
            @__parser.AddParsedSubObject(@__ctrl1);
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("\r\n    "));
            return @__ctrl;
        }
    ...
    <div class=""row"">
        ...
        [GeneratedCodeAttribute("Microsoft.VisualStudio.SharePoint.ProjectExtensions.CodeGenerators.SharePointWebP" +
            "artCodeGenerator", "12.0.0.0")]
        private void @__BuildControlTree(global::MultiComercial.wpListarComercial.wpListarComercial.wpListarComercial @__ctrl) {
            global::System.Web.UI.HtmlControls.HtmlGenericControl @__ctrl1;
        ...
        private void @__Render__control1(System.Web.UI.HtmlTextWriter @__w, System.Web.UI.Control parameterContainer) {
            @__w.Write("\r\n\r\n<link rel=\"stylesheet\" href=\"../../_layouts/15/PagerStyle.css\" />\r\n<script ty" +
                    "pe=\"text/javascript\" src=\"../../_layouts/15/MultiComercial/wpEmpresasRelacionada" +
                    "s.js\"></script>\r\n<script src=\"../../_layouts/15/MultiComercial/jquery-1.11.1.js\"" +
                    "></script>\r\n\r\n<style>\r\n .table-bordered a.glyphicon-plus-sign {color:#5fbeaa !Im" +
                    "portant;}\r\n .table-bordered a.glyphicon-plus-sign:focus,.table-bordered a.glyphi" +
                    "con-plus-sign:hover {color:#23527c !Important;}\r\n\r\n</style>\r\n\r\n<script type=\"tex" +
                    "t/javascript\">\r\n    function setFocus(obj) {\r\n        document.getElementById(ob" +
                    "j).focus();\r\n    }\r\n\r\n    document.onkeydown = function () {\r\n        if (window" +
                    ".event && (window.event.keyCode == 109 || window.event.keyCode == 56)) {SERVICIO" +
                    "S INDUSTRIALES INTEGRA LTDA.\r\n            window.event.keyCode = 505;\r\n        }" +
                    "\r\n\r\n        if (window.event.keyCode == 505) {\r\n            return false;\r\n     " +
                    "   }\r\n\r\n            if (window.event && (window.event.keyCode == 13)) {\r\n       " +
                    "         valor = document.activeElement.value;\r\n                if (valor == und" +
                    "efined) { return false; } //Evita Enter en página. \r\n                else {\r\n   " +
                    ...
                    "turn false; } //Evita Enter en radio. \r\n                    if (document.activeE" +
                    "lement.getAttribute(\'type\') == \'checkbox\')\r\n                    { return false; " +
