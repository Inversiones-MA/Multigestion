...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpEmpresaAdministracion.ascx.cs" Inherits="MultiComercial.wpEmpresaAdministracion.wpEmpresaAdministracion.wpEmpresaAdministracion" %>
                                        ...
                                        <div class="form-horizontal" role="form">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <SharePoint:DateTimeControl ID="dtcFecNaci" runat="server" LocaleId="13322" CssClassTextBox="form-control" Calendar="Gregorian" DateOnly="true" />
                                                    </div>
                                                </div>
