...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpRechazoOperacion.ascx.cs" Inherits="MultiComercial.wpDevolverOperacion.wpRechazoOperacion.wpRechazoOperacion" %>
