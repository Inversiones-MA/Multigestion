...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpClientes.ascx.cs" Inherits="MultiComercial.wpClientes.wpClientes.wpClientes" %>
    ...
    <div class="col-md-12">
        <div class="alert alert-gray">
            <p><strong>Empresa: <asp:Label ID="lbEmpresa" runat="server" Text=""></asp:Label></strong> / 
                ...
                / Ejecutivo: <asp:Label ID="lbEjecutivo" runat="server" Text=" "></asp:Label></p>
        </div>
    </div>
</div>
                                       ...
                                       <div class="form-horizontal" role="form">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:TextBox ID="txt_plazo" runat="server" CssClass="form-control" MaxLength="15"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                       </div>
                                        ...
                                        <div class="table-responsive">
                                            <div id="dv_buscarEmpresas" runat="server" class="row clearfix">
                                                <div class="col-md-12 column">
                                                    ...
                                                    <asp:GridView ID="ResultadosBusqueda" runat="server" class="table table-bordered table-hover" GridLines="Horizontal" OnRowCreated="ResultadosBusqueda_RowCreated" OnRowDataBound="ResultadosBusqueda_RowDataBound" RowHeaderColumn="0" ShowHeaderWhenEmpty="True" OnPageIndexChanging="ResultadosBusqueda_PageIndexChanging" PageSize="5" AutoGenerateColumns="true">
                                                    </asp:GridView>
                                                </div>
                                            </div>
                                        </div>
