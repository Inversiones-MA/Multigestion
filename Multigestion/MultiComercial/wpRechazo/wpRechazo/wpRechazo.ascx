...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpRechazo.ascx.cs" Inherits="MultiComercial.wpRechazo.wpRechazo.wpRechazo" %>
        ...
        <div class="card-box">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label>Estado de Rechazo:</label>
                    <asp:DropDownList ID="cb_estados" runat="server" CssClass="form-control" AutoPostBack="false"></asp:DropDownList>
                </div>
            ...
            <table style="width:100%">
                <tr>
                    ...
                    <td>
                        <div>
                            <asp:Button class="btn btn-primary btn-success pull-right" ID="btnGuardar" runat="server" Text="Enviar" OnClick="btnGuardar_Click" OnClientClick="return Dialogo();" />
