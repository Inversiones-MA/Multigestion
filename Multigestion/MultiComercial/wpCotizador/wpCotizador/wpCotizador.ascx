...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpCotizador.ascx.cs" Inherits="MultiComercial.wpCotizador.wpCotizador.wpCotizador" %>
...
<script type="text/javascript">
    ...
    function OncbVerificarRutComplete(s, e) {
        ...
        if (valores[0] != 'ok') {
            Alerta('La Empresa esta bloqueada en sistema por el siguiente motivo: ' + valores[0]);
            txtRutEmpresa.SetText(null);
            txtDivEmpresa.SetText(null);
            txtEmpresa.SetText(null);
            ddlEjecutivo.SetSelectedIndex(-1);
            //$("#dvFormulario").prop('disabled', true);
        }
        else {
            ddlEjecutivo.SetSelectedIndex(valores[1]);
    ...
    function Verifica(s, e) {
        try {
            ...
            if (rut != '' && div != '') {
                var a = rut + '-' + div;
                var ver = VerificarRut(rut + '-' + div);
                if (!ver) {
                    txtDivEmpresa.isValid = false;
                    div.isValid = false;
                    Alerta('rut invalido !!!');
                    return false;
                }
                    ...
                    ocultarDiv();
                    OpenDlg();
                    cbVerificarRut.PerformCallback('verRut');
                    return true;
                }
            }
        }
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-horizontal" role="form">
                ...
                <!-- Empresa -->
                <div class="row" runat="server" id="datosEmpresa">
                    <div class="col-md-12">
                        <div class="alert alert-gray">
                            <p>
                                <strong>Empresa:
                    <dx:ASPxLabel ID="lbEmpresa" runat="server" ClientInstanceName="lbEmpresa" ClientIDMode="Static"></dx:ASPxLabel>
                                </strong>/
                    <dx:ASPxLabel ID="lbRut" runat="server" ClientInstanceName="lbRut" ClientIDMode="Static"></dx:ASPxLabel>
                                / Negocio:
                    <dx:ASPxLabel ID="lbOperacion" runat="server" ClientInstanceName="lbOperacion" ClientIDMode="Static"></dx:ASPxLabel>
                                / Ejecutivo:
                    <dx:ASPxLabel ID="lbEjecutivo" runat="server" ClientInstanceName="lbEjecutivo" ClientIDMode="Static"></dx:ASPxLabel>
                            </p>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <table>
                                                                <tr>
                                                                    <td style="width: 70%">
                                                                        <dx:ASPxTextBox ID="txtRutEmpresa" runat="server" ClientInstanceName="txtRutEmpresa" MaxLength="8" CssClass="form-control" ValidationSettings-ValidationGroup="ValidarCotizador" Width="95%">
                                                                            <ClientSideEvents LostFocus="Verifica" />
                                                                    ...
                                                                    <td style="width: 20%">
                                                                        <dx:ASPxTextBox ID="txtDivEmpresa" runat="server" ClientInstanceName="txtDivEmpresa" MaxLength="1" CssClass="form-control" ValidationSettings-ValidationGroup="ValidarCotizador" ClientSideEvents-KeyPress="function(s,e){ esNumeroDv(s,e);}"  Width="95%">
                                                                            <ClientSideEvents LostFocus="Verifica" />
                                                                            <ValidationSettings Display="Dynamic" SetFocusOnError="True">
                                                                                <ErrorFrameStyle ForeColor="Red"></ErrorFrameStyle>
                                                                                <RequiredField IsRequired="true" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <dx:ASPxComboBox ID="ddlEjecutivo" runat="server" ClientInstanceName="ddlEjecutivo" ValueType="System.String" CssClass="form-control" NullText="Seleccione" ValidationSettings-ValidationGroup="ValidarCotizador" Width="98%">
                                                                <ValidationSettings Display="Dynamic" SetFocusOnError="True">
                                                                    <ErrorFrameStyle ForeColor="Red"></ErrorFrameStyle>
                                                                    <RequiredField IsRequired="true" />
                                                                </ValidationSettings>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <dx:ASPxTextBox ID="txtEmpresa" runat="server" ClientInstanceName="txtEmpresa" MaxLength="200" CssClass="form-control" ValidationSettings-ValidationGroup="ValidarCotizador" Width="97%">
                                                                <ValidationSettings Display="Dynamic" SetFocusOnError="True">
                                                                    <ErrorFrameStyle ForeColor="Red"></ErrorFrameStyle>
                                                                    <RequiredField IsRequired="true" />
                                                                </ValidationSettings>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group" id="divTxtHorizonte" style="display: none">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <dx:ASPxTextBox ID="txtHorizonte" ClientInstanceName="txtHorizonte" runat="server" MaxLength="3" 
                                                                CssClass="form-control" ValidationSettings-ValidationGroup="ValidarCotizador" Width="98%">
                                                                <ValidationSettings Display="Dynamic" SetFocusOnError="True">
                                                                    <ErrorFrameStyle ForeColor="Red"></ErrorFrameStyle>
                                                                    <RequiredField IsRequired="true" />
                                                                </ValidationSettings>
                                                    ...
                                                    <div class="form-group" id="divPlazo">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <table>
                                                                <tr>
                                                                    <td style="width: 55%">
                                                                        <dx:ASPxTextBox ID="txtTasaBanco" runat="server" ClientInstanceName="txtTasaBanco" MaxLength="6" CssClass="form-control" ValidationSettings-ValidationGroup="ValidarCotizador" Width="98%">
                                                                           <%-- ClientSideEvents-KeyPress="function(s,e){ esDecimal(s,e);}"--%>
                                                                            <ValidationSettings Display="Dynamic" SetFocusOnError="True">
                                                                                <ErrorFrameStyle ForeColor="Red"></ErrorFrameStyle>
                                                                                <RequiredField IsRequired="true" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <dx:ASPxTextBox ID="txtComisionAnual" runat="server" MaxLength="4" CssClass="form-control" ValidationSettings-ValidationGroup="ValidarCotizador" Width="98%">
                                                                <%--ClientSideEvents-KeyPress="function(s,e){ esDecimal(s,e);}"--%>
                                                                <ValidationSettings Display="Dynamic" SetFocusOnError="True">
                                                                    <ErrorFrameStyle ForeColor="Red"></ErrorFrameStyle>
                                                                    <RequiredField IsRequired="true" />
                                                                ...
                                                                <div class="card-box">
                                                                    <div class="table-responsive">
                                                                       <dx:ASPxGridView ID="GvGarantias" runat="server" ClientInstanceName="GvGarantias" Width="100%" 
                                                                            ...
                                                                            KeyFieldName="IdSeguro;IdTemporal" AutoGenerateColumns="false"
                                                ...
                                                <div class="col-md-12">
                                                    <table border="0" style="table-layout: fixed; width: 100%;">
                                                        <tr>
                                                            <td>
                                                                <div class="card-box">
                                                                    <%--<ClientSideEvents CustomButtonClick="ValidarEliminarAvales" />
                                                                    OnBatchUpdate="GvAvales_BatchUpdate" 
                                                                    OnCustomButtonCallback="GvAvales_CustomButtonCallback"--%>

                                                                    <div class="table-responsive">
                                                                        <dx:ASPxGridView ID="GvAvales" runat="server" ClientInstanceName="GvAvales" KeyFieldName="IdAvalCotizacion" Width="100%" CssClass="table table-responsive table-hover table-bordered"
                                                                            ...
                                                                            <SettingsText ConfirmDelete="¿Desea borrar el registro?" />
                                                                            <Columns>
                                                                                <dx:GridViewCommandColumn VisibleIndex="0" Width="5%" ShowNewButtonInHeader="true" ShowEditButton="true" ShowDeleteButton="true" Name="btn">
                                                                                    <HeaderTemplate>
                                                                                        <dx:ASPxButton ID="BtnNuevo" ClientInstanceName="BtnNuevo" runat="server" Text="Nuevo" RenderMode="Button" AutoPostBack="false" CssClass="btn btn-primary btn-success pull-right" Width="10%">
                                                    ...
                                                    <table border="0" style="table-layout: fixed; width: 100%;">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <dx:ASPxButton ID="btnGuardar" runat="server" Text="Cotizar" ClientInstanceName="btnGuardar" CssClass="btn btn-success pull-right" AutoPostBack="false" ValidationGroup="ValidarCotizador">
                ...
                <dx:ASPxCallback ID="cbVerificarRut" runat="server" ClientInstanceName="cbVerificarRut" OnCallback="cbVerificarRut_Callback">
                    <ClientSideEvents CallbackComplete="OncbVerificarRutComplete" />
                </dx:ASPxCallback>
