...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpAprobacionSolicitud.ascx.cs" Inherits="MultiFiscalia.wpAprobacionSolicitud.wpAprobacionSolicitud.wpAprobacionSolicitud" %>
 ...
 <div class="row">
    <div class="col-md-12">
        <div class="alert alert-gray">
            <p><strong>Empresa: <asp:Label ID="lbEmpresa" runat="server" Text=""></asp:Label></strong> / <asp:Label ID="lbRut" runat="server" Text=""></asp:Label> / Negocio: <asp:Label ID="Label1" runat="server" Text=""></asp:Label> / Ejecutivo: <asp:Label ID="Label2" runat="server" Text=""></asp:Label></p>
        </div>
    </div>
</div>
            ...
            <div class="card-box">
                        ...
                        <td>
                            <div class="table-responsive">
                                <asp:GridView ID="gridFiscalia" runat="server" GridLines="Horizontal" class="table table-bordered table-hover"
                                    RowHeaderColumn="0" ShowHeaderWhenEmpty="True" PageSize="10" DataKeyNames="IdServicio"
                                    OnRowCreated="gridFiscalia_RowCreated" ShowFooter="True" AutoGenerateColumns="False" OnDataBound="gridFiscalia_DataBound"
                                    OnRowDataBound="gridFiscalia_RowDataBound" >
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Critico" HeaderText="Servicio Crítico" Visible="false" />
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtTotal" runat="server" Width="80" MaxLength="18" onKeyPress="return solonumeros(event)" ReadOnly="true" BorderColor="Transparent"></asp:TextBox>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtTotalServicios" runat="server" Width="80" MaxLength="18" onKeyPress="return solonumeros(event)" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent"></asp:TextBox>
                                            </FooterTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                <asp:Label ID="lbh2" runat="server" Text="Servicio Crítico"></asp:Label>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="ckCritico" runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                ...
                <table style="width:100%">
                    ...
                    <tr>
                        ...
                        <td class="col-md-10">
                            <asp:TextBox ID="txtComentariosFiscalia" TextMode="multiline" Columns="20" Rows="5" runat="server" CssClass="col-md-12 control-label" MaxLength="1000" />
                        </td>
                    </tr>
                </table>
                <br />
                <table style="width:100%">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button ID="btnRechazar" runat="server" Text="Rechazar" OnClick="btnRechazar_Click" class="btn btn-warning pull-right" OnClientClick="return Dialogo();" Visible="false" />

                            <asp:Button class="btn btn-warning pull-center" ID="btnAprobar" runat="server" Text="Aprobar" OnClick="btnAprobar_Click" OnClientClick="return Dialogo();" />
                            ...
                            <asp:Button class="btn btn-primary btn-success pull-right" ID="btnFinLegal" runat="server" Text="Finalizar area Legal" OnClick="btnFinLegal_Click"  OnClientClick="return Dialogo();" />
                        </td>
                    </tr>
                </table>
