                                ...
                                <asp:Panel ID="pnFormulario" runat="server">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <h4>
                                                    <label class="control-label" style="background-color: #D5ECEB">1. Comportamiento</label>
                                                </h4>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <h4>
                                                    <label class="control-label" style="background-color: #D5ECEB">2. Simulación Capacidad de pago</label>
                                                </h4>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <h4>
                                                    <label class="control-label" style="background-color: #D5ECEB">3. Situación Patrimonial</label>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
