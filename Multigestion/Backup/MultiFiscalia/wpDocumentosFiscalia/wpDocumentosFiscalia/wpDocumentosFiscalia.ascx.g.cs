...
namespace MultiFiscalia.wpDocumentosFiscalia.wpDocumentosFiscalia {
    ...
    public partial class wpDocumentosFiscalia {
        ...
        protected global::System.Web.UI.WebControls.GridView gridDocumentosFiscalia;
        ...
        public static implicit operator global::System.Web.UI.TemplateControl(wpDocumentosFiscalia target) 
        {
        ...
        [global::System.ComponentModel.EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Never)]
        private global::System.Web.UI.WebControls.GridView @__BuildControlgridDocumentosFiscalia() {
            global::System.Web.UI.WebControls.GridView @__ctrl;
            @__ctrl = new global::System.Web.UI.WebControls.GridView();
            this.gridDocumentosFiscalia = @__ctrl;
            @__ctrl.ApplyStyleSheetSkin(this.Page);
            @__ctrl.ID = "gridDocumentosFiscalia";
            ...
            @__ctrl.SelectedIndexChanged -= new System.EventHandler(this.gridDocumentosFiscalia_SelectedIndexChanged);
            @__ctrl.SelectedIndexChanged += new System.EventHandler(this.gridDocumentosFiscalia_SelectedIndexChanged);
            @__ctrl.RowCreated -= new System.Web.UI.WebControls.GridViewRowEventHandler(this.gridDocumentosFiscalia_RowCreated);
            @__ctrl.RowCreated += new System.Web.UI.WebControls.GridViewRowEventHandler(this.gridDocumentosFiscalia_RowCreated);
            @__ctrl.RowCommand -= new System.Web.UI.WebControls.GridViewCommandEventHandler(this.gridDocumentosFiscalia_RowCommand);
            @__ctrl.RowCommand += new System.Web.UI.WebControls.GridViewCommandEventHandler(this.gridDocumentosFiscalia_RowCommand);
            return @__ctrl;
        }
        ...
        private global::System.Web.UI.HtmlControls.HtmlGenericControl @__BuildControldocumentos() {
            ...
            @__ctrl1 = this.@__BuildControlgridDocumentosFiscalia();
            @__parser.AddParsedSubObject(@__ctrl1);
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("\r\n                                "));
            return @__ctrl;
        }
    ...
    <div class=""row"">
        <div class=""col-md-12"">
            ...
            @__ctrl8 = this.@__BuildControldocumentos();
            @__parser.AddParsedSubObject(@__ctrl8);
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("\r\n                            </div>\r\n                        </div>\r\n           " +
                        "         </div>\r\n\r\n                    <br />\r\n                    "));
            global::System.Web.UI.HtmlControls.HtmlGenericControl @__ctrl9;
            @__ctrl9 = this.@__BuildControlbotones();
        ...
        [global::System.ComponentModel.EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Never)]
        private void @__BuildControlTree(global::MultiFiscalia.wpDocumentosFiscalia.wpDocumentosFiscalia.wpDocumentosFiscalia @__ctrl) {
            System.Web.UI.IParserAccessor @__parser = ((System.Web.UI.IParserAccessor)(@__ctrl));
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("\r\n\r\n<script type=\"text/javascript\" src=\"../../_layouts/15/MultiFiscalia/Fiscalia." +
                        "js\"></script>\r\n\r\n<script type=\"text/javascript\">\r\n    document.onkeydown = funct" +
                        "ion () {\r\n        //109->\'-\' \r\n        //56->\'(\' \r\n        if (window.event && (" +
                        "window.event.keyCode == 109 || window.event.keyCode == 56)) {\r\n            windo" +
                        "w.event.keyCode = 505;\r\n        }\r\n\r\n        if (window.event.keyCode == 505) {\r" +
                        ...
                        "or = document.activeElement.value;\r\n                if (valor == undefined) { re" +
                        "turn false; } //Evita Enter en página. \r\n                else {\r\n               " +
                        ...
                        "veElement.getAttribute(\'type\') == \'radio\')\r\n                    { return false; " +
                        ...
                        "o password \r\n                    {\r\n                        if (document.activeE" +
                        "lement.value.length == 0)\r\n                        { return false; } //No realiz" +
                        "a el backspace(largo igual a 0). \r\n                        //else {\r\n           " +
