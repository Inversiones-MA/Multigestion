...
namespace MultiFiscalia.wpCftFiscaliaExpress.wpCftFiscaliaExpress
{
    [ToolboxItemAttribute(false)]
    public partial class wpCftFiscaliaExpress : WebPart
    {
        ...
        private static string pagina = "ListarCftFiscalia.aspx";
            ...
            for (int i = 0; i <= dt.Rows.Count - 1; i++)
            {
                if (dt.Rows[i]["Opcion"].ToString() == e.CommandName)
                {
                    try
                    {
                        ...
                        resumenP.idOperacion = int.Parse(ResultadosBusqueda.Rows[index].Cells[27].Text.ToString());
                        ...
                        resumenP.descEjecutivo = ResultadosBusqueda.Rows[index].Cells[16].Text.ToString();
                        ...
                        resumenP.linkPrincial = "ListarCftFiscalia.aspx"; //
                        ...
                        resumenP.DescEstadoFiscalia = System.Web.HttpUtility.HtmlDecode(ResultadosBusqueda.Rows[index].Cells[18].Text.ToString());
                        resumenP.IdEstadoFiscalia = Convert.ToInt32(System.Web.HttpUtility.HtmlDecode(ResultadosBusqueda.Rows[index].Cells[17].Text.ToString()));
                        resumenP.IdAcreedor = Convert.ToInt32(System.Web.HttpUtility.HtmlDecode(ResultadosBusqueda.Rows[index].Cells[29].Text.ToString()));
                    ...
                    {
                        LoggingError.PostEventRegister(ex, ConfigurationManager.AppSettings["pathLog"].ToString(), "", "", ConfigurationManager.AppSettings["logName"].ToString(), Convert.ToBoolean(ConfigurationManager.AppSettings["enabledLog"].ToString()), Convert.ToBoolean(ConfigurationManager.AppSettings["enabledEventViewer"].ToString()), ConfigurationManager.AppSettings["registerEventsTypes"].ToString(), EventLogEntryType.Error);
                        Page.Response.Redirect("ListarCftFiscalia.aspx");
                    }
        ...
        protected void ResultadosBusqueda_RowCreated(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.Cells.Count > 2)
            {
                ...
                e.Row.Cells[2].Visible = false;//ID Empresa

                e.Row.Cells[5].Visible = false;//area
                e.Row.Cells[6].Visible = false;//area
                e.Row.Cells[7].Visible = false;//area

                e.Row.Cells[8].Visible = false;//area
                e.Row.Cells[9].Visible = false;//etapa
                e.Row.Cells[10].Visible = false;//SubEtapa
                e.Row.Cells[11].Visible = false;//doc operacion

                e.Row.Cells[12].Visible = false;//docgarantia
                e.Row.Cells[13].Visible = false;//validacion operacion

                e.Row.Cells[16].Visible = false;//val Empresa
                e.Row.Cells[17].Visible = false;//val detalle

                e.Row.Cells[19].Visible = false;//val detalle
                e.Row.Cells[20].Visible = false;//val detalle
                e.Row.Cells[21].Visible = false;//val detalle
                e.Row.Cells[22].Visible = false;//val detalle
                e.Row.Cells[23].Visible = false;//val detalle
                e.Row.Cells[24].Visible = false;//val detalle
                e.Row.Cells[25].Visible = false;//val detalle
                e.Row.Cells[26].Visible = false;//val detalle
                e.Row.Cells[27].Visible = false;//id operacion 

                e.Row.Cells[29].Visible = false;//id ACREEDOR
                e.Row.Cells[30].Visible = false;//prioridad
            }
        }
        ...
        private void ddlUsuariosFiscalia_Selected(string idoperacion, string usuarioF)
        {
        ...
        protected void CargarGrid(string etapa, string subEtapa, string estado, string buscar, int pageS, int pageN)
        {
            try
            {
                ...
                LogicaNegocio Ln = new LogicaNegocio();
                DataSet res;
                res = Ln.ListarFiscaliaCFT(etapa, subEtapa, estado, txtBuscar.Text.ToString(), ViewState["AREA"].ToString(), ViewState["CARGO"].ToString(), ViewState["USER"].ToString(), pageS, pageN, ddlEdoFiscalia.SelectedValue.ToString());
        ...
        private void PruebaEA()
        {
            foreach (GridViewRow row in ResultadosBusqueda.Rows)
            {
                ...
                {
                    ddlUsuariosFiscalia.Attributes.Add("onchange", "jsSelectUsuarios(" + row.Cells[27].Text + ", this)");
