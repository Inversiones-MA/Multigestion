...
namespace MultiAdministracion.wpPerfiles.wpPerfiles
{
    ...
    public partial class wpPerfiles : WebPart
    {
        ...
        private static string pagina = "Perfiles.aspx";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                dt = Ln.ListarPerfilesV2();

                grid.DataSource = dt;
                grid.DataBind();

                dtTipoOpciones = Ln.ListarTipoOpciones(modulo);
                hdn_Opciones["hdn_Opciones"] = DataTableToJSONWithStringBuilder(dtTipoOpciones);

                dtPermisos = Ln.ListarPermisos(null, null);
        ...
        protected void grid_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            bool resGuardar = Ln.GuardarPerfil(Descripcion, idOpciones, idPermiso, Modulo, true, Crud, IdCargoAccion);
        ...
        protected void grid_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            ...
            bool resGuardar = Ln.GuardarPerfil("", 0, 0, "", true, Crud, IdCargoAccion);
