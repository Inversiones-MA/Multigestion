    ...
    public partial class wpLimitesCorfo : WebPart
    {
        ...
        private void CargarData()
        {
            ...
            if (ds != null)
            {
                ...
                txtMaximoFianzaAlfa.Text = ds.Tables[0].Rows[0]["FianzaMaximaBeneficiarioUF"].ToString().GetFormatearNumero(0);
                txtMaximoFianzaReco.Text = ds.Tables[0].Rows[1]["FianzaMaximaBeneficiarioUF"].ToString().GetFormatearNumero(0);
                txtMaximoFianzaVictoria.Text = ds.Tables[0].Rows[2]["FianzaMaximaBeneficiarioUF"].ToString().GetFormatearNumero(0);
                txtMaximoFianzaBeta.Text = ds.Tables[0].Rows[3]["FianzaMaximaBeneficiarioUF"].ToString().GetFormatearNumero(0);
                ...
                txtTotalFianzaVigenteAlfaDPL.Text = ds.Tables[3].Rows[0]["TotalFianzaVigenteAlfa"].ToString().GetFormatearNumero(0);
                txtTotalFianzaVigenteRecoDPL.Text = ds.Tables[4].Rows[0]["TotalFianzaVigenteReco"].ToString().GetFormatearNumero(0);
                txtTotalFianzaVigenteVictoriaDPL.Text = ds.Tables[5].Rows[0]["TotalFianzaVigenteVictoria"].ToString().GetFormatearNumero(0);
                txtTotalFianzaVigenteBetaDPL.Text = ds.Tables[6].Rows[0]["TotalFianzaVigenteBeta"].ToString().GetFormatearNumero(0);
                ...
                txtTotalFianzaVigenteAlfa.Text = ds.Tables[3].Rows[0]["TotalFianzaVigenteAlfa"].ToString().GetFormatearNumero(0);
                txtTotalFianzaVigenteReco.Text = ds.Tables[4].Rows[0]["TotalFianzaVigenteReco"].ToString().GetFormatearNumero(0);
                txtTotalFianzaVigenteVictoria.Text = ds.Tables[5].Rows[0]["TotalFianzaVigenteVictoria"].ToString().GetFormatearNumero(0);
                txtTotalFianzaVigenteBeta.Text = ds.Tables[6].Rows[0]["TotalFianzaVigenteBeta"].ToString().GetFormatearNumero(0);
            }
        }
