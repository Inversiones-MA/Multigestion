    ...
    public partial class wpProrrateoGarantias : WebPart
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (permiteGuardar)
            {
                ...
                exito = Ln.InsertarProrrateo(objresumen.idEmpresa.ToString(), XMLGarantias, XMLOperaciones, objresumen.idUsuario, objresumen.descCargo);
                if (exito)
                {
        ...
        protected void ResultadosBusquedaOperaciones_DataBound(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i <= ResultadosBusquedaOperaciones.Rows.Count - 1; i++)
            {
                ...
                if (System.Web.HttpUtility.HtmlDecode(ResultadosBusquedaOperaciones.Rows[i].Cells[12].Text) != " ")
                {
                    ...
                    double b = 0;
                    if (!string.IsNullOrEmpty(dt.Rows[i]["Fogape"].ToString()) && dt.Rows[i]["Fogape"].ToString().GetValorDouble() > 0)
                        b = a + double.Parse(dt.Rows[i]["Fogape"].ToString().Replace(".", "").Replace(",", "."));

                    //(ResultadosBusquedaOperaciones.Rows[i].FindControl("TotalGarantias") as TextBox).Text = util.formatearNumero(a, 3);
                    var aa = util.formatearNumero(a, 3);
                    var bb = a.ToString().GetFormatearNumero(3);
                    (ResultadosBusquedaOperaciones.Rows[i].FindControl("TotalGarantias") as TextBox).Text = a.ToString().GetFormatearNumero(3);

                    //(ResultadosBusquedaOperaciones.Rows[i].FindControl("TotalGarantiasFogape") as TextBox).Text = b == 0 ? util.formatearNumero(a, 3) : util.formatearNumero(b, 3);
                    (ResultadosBusquedaOperaciones.Rows[i].FindControl("TotalGarantiasFogape") as TextBox).Text = b == 0 ? a.ToString().GetFormatearNumero(3) : b.ToString().GetFormatearNumero(3);
                }
                ...
                if (System.Web.HttpUtility.HtmlDecode(ResultadosBusquedaOperaciones.Rows[i].Cells[14].Text) != "")
                {
                        ...
                        && double.Parse((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoDeudaTotal") as TextBox).Text.ToString().Replace(".", "").Replace(",", ".")) > 0)
                    {
                        ...
                        if ((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoVigente") as TextBox).Text.Trim().GetValorDouble() <= 0)
                ...
                if (System.Web.HttpUtility.HtmlDecode(ResultadosBusquedaOperaciones.Rows[i].Cells[21].Text) != " " || System.Web.HttpUtility.HtmlDecode(ResultadosBusquedaOperaciones.Rows[i].Cells[21].Text) != "")
                {
                        ...
                        && double.Parse((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoDeudaTotal") as TextBox).Text.ToString().Replace(".", "").Replace(",", ".")) > 0)
                    {
                        ...
                        var txtMontoVigente = (ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoVigente") as TextBox).Text.ToString();
                        var TT = (ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoDeudaTotal") as TextBox).Text.Trim();

                        if ((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoVigente") as TextBox).Text.Trim().GetValorDouble() <= 0)
                            (ResultadosBusquedaOperaciones.Rows[i].FindControl("txtCoberturaFogape") as TextBox).Text = (((ResultadosBusquedaOperaciones.Rows[i].FindControl("TotalGarantiasFogape") as TextBox).Text.Trim().GetValorDouble() / ((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoDeudaTotal") as TextBox).Text.Trim().GetValorDouble())) * 100).ToString().GetFormatearNumero(3);
                            //(ResultadosBusquedaOperaciones.Rows[i].FindControl("txtCoberturaFogape") as TextBox).Text = util.formatearNumero((((ResultadosBusquedaOperaciones.Rows[i].FindControl("TotalGarantiasFogape") as TextBox).Text.Trim().GetValorDouble() / ((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoDeudaTotal") as TextBox).Text.Trim().GetValorDouble())) * 100), 3);
                        else
                            (ResultadosBusquedaOperaciones.Rows[i].FindControl("txtCoberturaFogape") as TextBox).Text = (((ResultadosBusquedaOperaciones.Rows[i].FindControl("TotalGarantiasFogape") as TextBox).Text.Trim().GetValorDouble() / ((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoVigente") as TextBox).Text.Trim().GetValorDouble()))*100).ToString().GetFormatearNumero(3);
                            //(ResultadosBusquedaOperaciones.Rows[i].FindControl("txtCoberturaFogape") as TextBox).Text = util.formatearNumero((((ResultadosBusquedaOperaciones.Rows[i].FindControl("TotalGarantiasFogape") as TextBox).Text.Trim().GetValorDouble() / ((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoVigente") as TextBox).Text.Trim().GetValorDouble())) * 100), 3);

                        //Convert.ToDecimal((double.Parse((ResultadosBusquedaOperaciones.Rows[i].FindControl("TotalGarantiasFogape") as TextBox).Text.ToString().Replace(".", "").Replace(",", ".")) / double.Parse((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoVigente") as TextBox).Text.ToString().Replace(".", "").Replace(",", "."))) * 100).ToString("N3", CultureInfo.CreateSpecificCulture("es-ES"));
                    }
                    else
            ...
            if (ResultadosBusquedaOperaciones.Rows.Count > 0)
            {
                ...
                {
                    if (TotalMontosVigentes <= 0)
                        (ResultadosBusquedaOperaciones.FooterRow.FindControl("txtTotalCobertura") as TextBox).Text = Convert.ToDecimal(((TotalHipoteca + TotalPrendas + TotalOtros) / TotalMontoDeudaTotal) * 100).ToString("N3", CultureInfo.CreateSpecificCulture("es-ES"));
                    else
                ...
                {
                    if (TotalMontosVigentes <= 0)
                        (ResultadosBusquedaOperaciones.FooterRow.FindControl("txtTotalCoberturaFogape") as TextBox).Text = Convert.ToDecimal(((TotalHipoteca + TotalPrendas + TotalOtros + TotalFogape) / TotalMontoDeudaTotal) * 100).ToString("N3", CultureInfo.CreateSpecificCulture("es-ES"));
                    else
        ...
        protected void ActualizarOperaciones_Click(object sender, EventArgs e)
        {
            ...
            DS = Ln.ActualizarDatosProrrateo(objresumen.idEmpresa.ToString(), "0", objresumen.idUsuario, objresumen.descCargo);
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            string Reporte = "ProrrateoGarantias";

            byte[] archivo = new Reportes { }.GenerarReporteProrrateo(Reporte, datos, "", objresumen);
            if (archivo != null)
            {
