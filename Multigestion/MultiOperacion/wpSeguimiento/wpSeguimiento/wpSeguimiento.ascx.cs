...
namespace MultiOperacion.wpSeguimiento.wpSeguimiento
{
    ...
    public partial class wpSeguimiento : WebPart
    {
        ...
        protected void inicializacionGrillas()
        {
            LogicaNegocio Ln = new LogicaNegocio();
            DataTable res;
            res = Ln.CP_GestionCalendarioPagp(ddlAcreedor.SelectedValue, ddlEdoCertificado.SelectedValue, ddlEjecutivo.SelectedItem.ToString(), false, false, false, false, false, "k", "k", "01");
