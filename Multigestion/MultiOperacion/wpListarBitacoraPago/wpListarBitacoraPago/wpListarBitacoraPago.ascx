...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpListarBitacoraPago.ascx.cs" Inherits="MultiOperacion.wpListarBitacoraPago.wpListarBitacoraPago.wpListarBitacoraPago" %>


<script type="text/javascript" src="../_layouts/15/Multiaval/Scripts/wp/wpEmpresasRelacionadas.js"></script>
...
<br />
<br />
<div id="dvFormulario" runat="server" style="display: block">
 ...
 <div class="row clearfix">
    ...
    <br />
    <div id="Div1" runat="server" style="display: none" class="alert alert-success">

        <h4>
            <asp:Label ID="Label1" runat="server" Text="Mensaje Informacion de alguna cuestion de Particular."></asp:Label>
        </h4>
    </div>



    <div id="Div2" runat="server" style="display: none" class="alert alert-success" role="alert">
        <h4>
            <asp:Label ID="Label2" runat="server" Text="Mensaje de warning de alguna cuestion de Particular."></asp:Label>
        </h4>
    </div>
    <div id="Div3" runat="server" style="display: none" class="alert alert-danger">
        <h4>
            <asp:Label ID="Label3" runat="server" Text="Mensaje de Error de alguna cuestion de Particular."></asp:Label>
        </h4>
    </div>
    ...
    <div id="dvWarning" runat="server" style="display: none" class="alert alert-warning" role="alert">
        <h4>
            <asp:Label ID="lbWarning" runat="server" Text="Mensaje de warning de alguna cuestion de Particular."></asp:Label>
        </h4>
    </div>
...
<div id="unauthorized" runat="server">
    <h2>Usuario No Autorizado. Por favor contacte al administrador del sistema.</h2>
</div>