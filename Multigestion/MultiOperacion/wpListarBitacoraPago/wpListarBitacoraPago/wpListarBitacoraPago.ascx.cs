...
//using wpListarNegocio.Interfaz;
using FrameworkIntercapIT.Utilities;
//using wpListarOperaciones.Interfaz;
    ...
    public partial class wpListarBitacoraPago : WebPart
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                Cargos = MTO.Buscar_Usuario(app2.CurrentUser.Name);
                CARGO = ObtenerValor(Cargos);
                //CARGO = "Contabilidad";
                ...
                AREA = "Operaciones";
                USER = ObtenerValor(app2.CurrentUser.Name);
