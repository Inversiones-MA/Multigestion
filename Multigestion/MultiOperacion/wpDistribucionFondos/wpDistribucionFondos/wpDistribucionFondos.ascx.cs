    ...
    public partial class wpDistribucionFondos : WebPart
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (objresumen.area.Trim() == "Operaciones")
            {
                ...
                {
                    exito = Ln.InsertarDistribucionFondos(objresumen.idEmpresa.ToString(), objresumen.idOperacion.ToString(), objresumen.idUsuario, objresumen.descCargo, xmlDistFondo);
                    if (exito)
                    {
        ...
        protected void mostrarDatos()
        {
            ...
            res = Ln.ListarDistribucionFondos(objresumen.idEmpresa.ToString(), objresumen.idOperacion.ToString(), objresumen.idUsuario, objresumen.descCargo);
