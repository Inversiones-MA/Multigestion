...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpListarOperaciones.ascx.cs" Inherits="MultiOperacion.wpListarOperaciones.wpListarOperaciones.wpListarOperaciones" %>

<link rel="stylesheet" href="../../_layouts/15/PagerStyle.css" />

<script type="text/javascript" src="../../_layouts/15/MultiOperacion/wpEmpresasRelacionadas.js"></script>
...
<div id="dvFormulario" runat="server">
    ...
    <div class="row marginInicio">
        <div class="col-sm-12">
            <h4 class="page-title">Operacion</h4>
            <ol class="breadcrumb">
                <li>
                    <a href="#">Inicio</a>
                </li>
                <li class="active">Operaciones
                </li>
            </ol>
        </div>
    </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <asp:TextBox ID="txtBuscar" runat="server" CssClass="form-control" TextMode="Search" placeholder="Buscar"></asp:TextBox>
