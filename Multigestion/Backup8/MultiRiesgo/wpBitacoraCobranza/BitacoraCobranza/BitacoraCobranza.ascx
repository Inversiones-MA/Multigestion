...
<script type="text/javascript">
    ...
    function clickAccion(s, e) {
        ...
        if (e.buttonID == 'gestion') {        
            ...
            mensaje = mensaje.concat('¿Desea generar el proceso de Reestructuración para el certificado ', keyValue.split("|")[0], '?'); //string1.concat(string2);
    ...
    function EndGuardar(s, e) {
        ...
        //cmbMoraProyectada.SetText('');
        //cmbMoraProyectada.SetValue(null);
        //var mora = cbxMora.GetSelectedItem().text;
        //var acreedor = cbxAcreedor.GetSelectedItem().text;
    ...
    //    var endDate = FechaGestion.GetValue();

    //    var difference = -1;
    //    if (startDate != null && endDate != null) {

    //        var dias = restarFechasV2(startDate, endDate)
    //        if (dias < 0) {
    //            e.isValid = false;
    //            e.errorText = 'la fecha de compromiso no puede ser menor a hoy';
    //        }
    //        else {
    //            FechaGestion.isValid = true;
    //            FechaGestion.errorText = '';
    //        }
    //    }
    //}

    //function restarFechasV2(fechaInicio, fechaFin) {
    ...
    //        cmbMoraProyectada.SetEnabled(false);
    //    }
    //    else {
    //        cmbMoraProyectada.SetEnabled(true);
    //    }
    //}

    //function OncmbMoraProyectada(s, e) {
    //    var item = s.GetSelectedItem();

    //    if (item.value == '0') {
    //        chkReprogramacion.SetValue(false);
    //        chkReprogramacion.SetEnabled(true);
    //    }
    //    else
    //        chkReprogramacion.SetEnabled(false);
    //}
...
<div id="dvFormulario" runat="server">
                    ...
                    <td>
                        <div class="card-box">
                            <div class="table-responsive">
                                ...
                                <dx:ASPxGridView ID="gvBitacoraCobranza" runat="server" AutoGenerateColumns="False" Width="100%" ClientInstanceName="gvBitacoraCobranza" ClientIDMode="Static"
                                    KeyFieldName="NumCertificado;CantidadCuotasImpagas;IdOperacion;EsReestructuracion"
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataColumn FieldName="GarantiaVA" Caption="Garantía Valor Ajustado" HeaderStyle-Wrap="True" VisibleIndex="14" CellStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                        </dx:GridViewDataColumn>

                                        <dx:GridViewDataColumn FieldName="CobFOGAPE" Caption="Cobertura Fogape" HeaderStyle-Wrap="True" VisibleIndex="15" CellStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                        </dx:GridViewDataColumn>

                                         <dx:GridViewDataColumn FieldName="MontoFogape" Caption="Monto Fogape" HeaderStyle-Wrap="True" VisibleIndex="16" CellStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                        </dx:GridViewDataColumn>

                                        <dx:GridViewDataTextColumn FieldName="UltimoCompromiso" Caption="Ultimo Compromiso" HeaderStyle-Wrap="True" VisibleIndex="17" CellStyle-HorizontalAlign="Center" Width="10%">
                                            <DataItemTemplate>
                                        ...
                                        <dx:GridViewDataColumn FieldName="UltimafecGestion" Caption="Fecha Gestión" HeaderStyle-Wrap="True" VisibleIndex="18" CellStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                            <%--<PropertiesTextEdit DisplayFormatString="N0" />--%>
                                        </dx:GridViewDataColumn>

                                        <dx:GridViewDataColumn FieldName="fec1erVencimiento" Caption="Fecha 1er Vencimiento" HeaderStyle-Wrap="True" VisibleIndex="19" CellStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                            <%--<PropertiesTextEdit DisplayFormatString="N0" />--%>
                                        </dx:GridViewDataColumn>

                                        <dx:GridViewDataColumn FieldName="fecEmision" Caption="Fecha Emisión" HeaderStyle-Wrap="True" VisibleIndex="20" CellStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                            <%--<PropertiesTextEdit DisplayFormatString="N0" />--%>
                                        </dx:GridViewDataColumn>

                                        <dx:GridViewDataColumn FieldName="EsReestructuracion" HeaderStyle-Wrap="True" VisibleIndex="21" CellStyle-HorizontalAlign="Center" Visible="false">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                        </dx:GridViewDataColumn>
                                                       
                                        <dx:GridViewCommandColumn Caption="Acciones" Name="Acciones" CellStyle-HorizontalAlign="Center" VisibleIndex="21" HeaderStyle-HorizontalAlign="Center" ButtonType="Image">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
                                            <CustomButtons>
                                                ...
                                                <div class="card-box">
                                                    <div class="table-responsive">
                                                        ...
                                                        <dx:ASPxGridView ID="gvBitacoraGestion" runat="server" ClientInstanceName="gvBitacoraGestion" KeyFieldName="IdCobranza" ClientIDMode="Static" Width="100%"
                                                            OnRowInserting="gvBitacoraGestion_RowInserting" OnPageIndexChanged="gvBitacoraGestion_PageIndexChanged" OnCellEditorInitialize="gvBitacoraGestion_CellEditorInitialize">
                                                            <Columns>
                                                                <%--<dx:GridViewCommandColumn VisibleIndex="0" Width="5%" ShowEditButton="false" ShowDeleteButton="false">
                                                                    <HeaderTemplate>
                                                                        <dx:ASPxButton ID="BtnNewComentario" ClientInstanceName="BtnNewComentario" runat="server" Text="Nueva Gestión" RenderMode="Button"
                                                                            AutoPostBack="false" CssClass="btn btn-block btn-warning btn-xs" Width="10%">
                                                                            <ClientSideEvents Click="AgregarComentario" />
                                                                        </dx:ASPxButton>
                                                                    </HeaderTemplate>
                                                                </dx:GridViewCommandColumn>--%>
                                                                ...
                                                                <dx:GridViewDataDateColumn FieldName="FechaGestion" Caption="Fecha Gestión" HeaderStyle-Wrap="True" VisibleIndex="5" CellStyle-HorizontalAlign="Center" ShowInCustomizationForm="true" PropertiesDateEdit-DisplayFormatString="dd-MM-yyyy" PropertiesDateEdit-EditFormat="Date"
                                                                    PropertiesDateEdit-EditFormatString="dd-MM-yyyy" Width="30%">
                                                                ...
                                                                <dx:GridViewDataTextColumn FieldName="Comentario" Caption="Comentario" HeaderStyle-Wrap="True" VisibleIndex="6" CellStyle-HorizontalAlign="Center" Width="30%">
                                                                    <EditItemTemplate>
                                                                        <dx:ASPxMemo runat="server" ID="txtUltimoMensaje" ClientIDMode="Static" Rows="3" MaxLength="250" ClientInstanceName="txtUltimoMensaje"
                                                                            Columns="16" Text='<%# Eval("Comentario") %>' Border-BorderWidth="2px">
                                                                        </dx:ASPxMemo>
                                                                    </EditItemTemplate>
                                                                    <PropertiesTextEdit>
                                                                        <ValidationSettings>
    ...
    <asp:SqlDataSource runat="server" ID="dsTipoAccion" ConnectionString="<%$ ConnectionStrings:DACConnectionString %>" SelectCommand="select Id, AccionCobranza from CobranzaAccion where Habilitado = 1 order by AccionCobranza asc " SelectCommandType="Text"></asp:SqlDataSource>
</div>
