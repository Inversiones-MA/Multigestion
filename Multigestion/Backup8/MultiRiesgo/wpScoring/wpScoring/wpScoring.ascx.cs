    ...
    public partial class wpScoring : WebPart
    {
        ...
        protected void cargarCombo()
        {
            ...
            if (ds != null)
            {
                ...
                util.CargaDDLDx(cbActividad, dt, "Nombres", "ID");
            }
        }
        ...
        //{
        //0 en lbPond y le asigna el valor2
        //1 en lbptje le asigna la (multiplicacion entre el valor1 y lbpond)/100 por ser porcentaje
        //2 en lbptje le asigna la (multiplicacion entre el valor2 y lbpond)/100 por ser porcentaje
        // btnLimpiar.OnClientClick = "return LimpiarVacido("','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');";

        //cbMorosidad.Attributes.Add("onchange", "return cal('" + cbMorosidad.ClientID + "','" + lbPondMorosidad.ClientID + "','" + 0 + "','" + lbPondMorosidad.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbMonto.Attributes.Add("onchange", "return cal('" + cbMonto.ClientID + "','" + lbPondMonto.ClientID + "','" + 0 + "','" + lbPondMonto.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbCalidadBalance.Attributes.Add("onchange", "return cal('" + cbCalidadBalance.ClientID + "','" + lbPtjeCalidadBalance.ClientID + "','" + 1 + "','" + lbPondCalidadBalance.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbCalidadGarantia.Attributes.Add("onchange", "return cal('" + cbCalidadGarantia.ClientID + "','" + lbPtjeCalidadGarantia.ClientID + "','" + 1 + "','" + lbPondCalidadGarantia.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbCoberturaGarantia.Attributes.Add("onchange", "return cal('" + cbCoberturaGarantia.ClientID + "','" + lbPtjeCoberturaGarantia.ClientID + "','" + 1 + "','" + lbPondCoberturaGarantia.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbConcentracion.Attributes.Add("onchange", "return cal('" + cbConcentracion.ClientID + "','" + lbPtjeConcentracion.ClientID + "','" + 1 + "','" + lbPondConcentracion.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbCompetencia.Attributes.Add("onchange", "return cal('" + cbCompetencia.ClientID + "','" + lbPtjeCompetencia.ClientID + "','" + 1 + "','" + lbPondCompetencia.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbEbitda.Attributes.Add("onchange", "return cal('" + cbEbitda.ClientID + "','" + lbPtjeEbitda.ClientID + "','" + 1 + "','" + lbPondEbitda.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbExperiencia.Attributes.Add("onchange", "return cal('" + cbExperiencia.ClientID + "','" + lbPtjeExperiencia.ClientID + "','" + 2 + "','" + lbPondExperiencia.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbLeverage.Attributes.Add("onchange", "return cal('" + cbLeverage.ClientID + "','" + lbPtjeLeverage.ClientID + "','" + 1 + "','" + lbPondLeverage.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbLiquidez.Attributes.Add("onchange", "return cal('" + cbLiquidez.ClientID + "','" + lbPtjeLiquidez.ClientID + "','" + 2 + "','" + lbPondLiquidez.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbPasivo.Attributes.Add("onchange", "return cal('" + cbPasivo.ClientID + "','" + lbPtjePasivo.ClientID + "','" + 1 + "','" + lbPondPasivo.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbPasivoVts.Attributes.Add("onchange", "return cal('" + cbPasivoVts.ClientID + "','" + lbPtjePasivoVts.ClientID + "','" + 1 + "','" + lbPondPasivoVts.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbTipoGarantia.Attributes.Add("onchange", "return cal('" + cbTipoGarantia.ClientID + "','" + lbPtjeTipoGarantia.ClientID + "','" + 1 + "','" + lbPondTipoGarantia.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");
        //cbActividad.Attributes.Add("onchange", "return calAct('" + cbActividad.ClientID + "','" + lbPtjeActividad.ClientID + "','" + 3 + "','" + lbPondActividad.ClientID + "','" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');");

        //onkeydown="return validarLetras(event)"/
        //btnLimpiar.OnClientClick = "return LimpiarVacido('" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');";
        //lbEditar.OnClientClick = "return HabilitarScoring('" + btnGuardar.ClientID.Substring(0, btnGuardar.ClientID.Length - 10) + "');";
        //}
        ...
        protected void cargarDatos()
        {
            try
            {
                ...
                LogicaNegocio MTO = new LogicaNegocio();
                DataTable dt = new DataTable();
                dt = MTO.ListarScoring(objresumen.idEmpresa.ToString(), objresumen.idUsuario, objresumen.desPermiso, "04");
                if (dt.Rows.Count > 0)
                {
        ...
        protected void cbpGuardarScoring_Callback(object source, DevExpress.Web.CallbackEventArgs e)
        {
            if (!string.IsNullOrEmpty(e.Parameter))
            {
                ...
                if (rowValueItems[0] == "indCaso0")
                {
                    ...
                    if (result.Length > 0)
                        e.Result = string.Format("{0}{1}{2}", rowValueItems[0], "~", result[0]["Descripcion"].ToString() + "/" + result[0]["Valor1"].ToString());
                    else
                        e.Result = string.Format("{0}{1}{2}", rowValueItems[0], "~", "Error al obtener el valor" + " " + rowValueItems[0]);
                }
                ...
                if (rowValueItems[0] == "indCaso3")
                {
                    ...
                    if (result.Length > 0)
                        e.Result = string.Format("{0}{1}{2}", rowValueItems[0], "~", result[0]["Valor2"].ToString());
                    else
                        e.Result = string.Format("{0}{1}{2}", rowValueItems[0], "~", "Error al obtener el valor" + " " + rowValueItems[0]);
                }
                ...
                if (rowValueItems[0] == "indCaso2")
                {
                    ...
                    if (rowValueItems[1].Contains("/"))
                    {
                        ...
                        var resultado = rowValueItems[1].IndexOf('/', offset + 1);
                        descripcion = rowValueItems[1].Substring(0, resultado);
                    }
                    else
