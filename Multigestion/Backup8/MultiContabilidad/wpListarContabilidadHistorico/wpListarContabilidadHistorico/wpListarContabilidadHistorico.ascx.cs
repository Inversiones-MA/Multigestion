    ...
    public partial class wpListarContabilidadHistorico : WebPart
    {
        ...
        protected void CargarGrid(string etapa, string subEtapa, string estado, string buscar, int pageS, int pageN)
        {
            try
            {
                ...
                res = MTO.ListarContabilidadHistorial(ViewState["CARGO"].ToString(), ViewState["USER"].ToString(), ddlTipoTransaccion.SelectedValue, int.Parse(ddlEstado.SelectedValue), txtNroTransaccion.Text,
