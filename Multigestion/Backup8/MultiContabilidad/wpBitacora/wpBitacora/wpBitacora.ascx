...
<script type="text/javascript">
    ...
    function SubirCargaMasiva() {
        cbpCargarCC.PerformCallback("InsertarCuenta");
    }
...
<div id="dvFormulario" runat="server">
    ...
    <dx:ASPxCallback ID="cbpCargarCC" ClientInstanceName="cbpCargarCC" ClientIDMode="Static" OnCallback="cbpCargarCC_Callback" runat="server">
