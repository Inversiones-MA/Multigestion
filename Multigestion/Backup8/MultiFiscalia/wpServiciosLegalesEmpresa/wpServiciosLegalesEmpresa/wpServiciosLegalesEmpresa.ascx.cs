...
namespace MultiFiscalia.wpServiciosLegalesEmpresa.wpServiciosLegalesEmpresa
{
    ...
    public partial class wpServiciosLegalesEmpresa : WebPart
    {
        ...
        public void guardarArchivo()
        {
            ...
            util.CargarDocFiscalia(carpetaEmpresa, objresumen.area, fileDocumento, objresumen.idEmpresa.ToString(), ddlTipo.SelectedItem.Text, lbOperacion.Text.Trim(), "Servicios Legales Empresa", Path.GetExtension(fileDocumento.FileName).ToLower());
        }
