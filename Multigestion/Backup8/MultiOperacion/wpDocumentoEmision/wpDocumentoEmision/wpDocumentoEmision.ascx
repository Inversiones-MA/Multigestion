...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpDocumentoEmision.ascx.cs" Inherits="MultiOperacion.wpDocumentoEmision.wpDocumentoEmision.wpDocumentoEmision" %>
                        ...
                        <div class="col-md-12">
                            <div class="card-box">
                                <div class="table-responsive" id="documentos" runat="server" visible="true">
                                    ...
                                    <asp:GridView ID="gridDocumentosCurse" runat="server" GridLines="Horizontal" class="table table-responsive table-hover table-bordered"
                                        DataKeyNames="IdPlantillaDocumento,NombrePlantilla" AutoGenerateColumns="False" OnSelectedIndexChanged="gridDocumentosCurse_SelectedIndexChanged" OnRowCreated="gridDocumentosCurse_RowCreated"
                                        OnRowCommand="gridDocumentosCurse_RowCommand">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Accion">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="LnkDescargar" runat="server" CommandName="Descargar" CssClass="glyphicon glyphicon-save paddingIconos text-muted" ToolTip="Descargar" CommandArgument='<%# Eval("IdPlantillaDocumento") + ";" +Eval("NombrePlantilla") %>' OnClientClick="return Dialogo();"></asp:LinkButton>
                                                    <asp:LinkButton ID="LnkAdjuntar" runat="server" CommandName="Adjuntar" CssClass="glyphicon glyphicon-open paddingIconos text-muted" ToolTip="Adjuntar" CommandArgument=""></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
