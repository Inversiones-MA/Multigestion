...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpListarSeguimiento.ascx.cs" Inherits="MultiOperacion.wpListarSeguimiento.wpListarSeguimiento.wpListarSeguimiento" %>
...
<div class="row">
 ...
 <div style="display:none">
    <asp:Button ID="btnrefrescar" runat="server" Text="" ClientIDMode="Static" OnClick="btnrefrescar_Click" />
</div>
