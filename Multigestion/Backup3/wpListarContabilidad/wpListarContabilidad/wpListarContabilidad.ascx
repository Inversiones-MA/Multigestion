...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpListarContabilidad.ascx.cs" Inherits="MultiContabilidad.wpListarContabilidad.wpListarContabilidad.wpListarContabilidad" %>
    ...
    document.onkeydown = function () {
        ...
        if (window.event && (window.event.keyCode == 13)) {
            ...
            if (valor == undefined) { return false; } //Evita Enter en página. 
                ...
                if (document.getElementById('<%=txtNroTransaccion.ClientID %>').val != '' && document.getElementById('<%=txtNCertificado.ClientID %>').val != '' && document.getElementById('<%=txtRUT.ClientID %>').val != '' && document.getElementById('<%=txtBuscar.ClientID %>').val != '') {
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlTipoTransaccion" CssClass="form-control" runat="server">
                               <%-- <asp:ListItem Value="-1">Seleccione</asp:ListItem>
                                <asp:ListItem Value="1">Asesoría</asp:ListItem>
                                <asp:ListItem Value="2">Comisión</asp:ListItem>
                                <asp:ListItem Value="3">Devolución Comisión</asp:ListItem>
                                <asp:ListItem Value="4">Gastos Operacionales</asp:ListItem>
                                <asp:ListItem Value="5">Seguros</asp:ListItem>--%>
                            </asp:DropDownList>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlEstado" CssClass="form-control" runat="server">
                                <%--<asp:ListItem Value="-1">Seleccione</asp:ListItem>
                                <asp:ListItem Value="1">Por Facturar</asp:ListItem>
                                <asp:ListItem Value="2">Facturado</asp:ListItem>
                                <asp:ListItem Value="3">Pagado</asp:ListItem>--%>
                            </asp:DropDownList>
                        </div>
