...
<div id="dvFormulario" runat="server">
                ...
                <div class="tab-pane active" id="tab2">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <div class="form-group">
                                <label for=""></label>
                                <dx:ASPxCheckBox ID="ckbVencidos" runat="server" ClientInstanceName="ckbVencidos" Text="Vencidos" CssClass="form-control"></dx:ASPxCheckBox>
                            </div>
                        </div>
                        <!-- col 2/4 -->
                        <div class="col-md-3 col-sm-6">
                            ...
                            <div class="form-group">
                                <label for=""></label>
                                <dx:ASPxCheckBox ID="ckbPagados" runat="server" ClientInstanceName="ckbPagados" Text="Pagados" CssClass="form-control"></dx:ASPxCheckBox>
                            </div>
                        </div>
                        <!-- col 3/4 -->
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <dx:ASPxTextBox ID="txtCertificado" runat="server" ClientInstanceName="txtCertificado" CssClass="form-control" MaxLength="8"></dx:ASPxTextBox>
                            </div>
                            <div class="form-group">
                                <label for=""></label>
                                <dx:ASPxCheckBox ID="ckbPendiente" runat="server" ClientInstanceName="ckbPendiente" Text="Pendiente Mes" CssClass="form-control"></dx:ASPxCheckBox>
                            </div>
                        </div>
                        <!-- col 4/4 -->
                                    ...
                                    <tr>
                                        <td>
                                            <%--<div class="table-responsive">
                                                <asp:GridView ID="gridCalendarioPago" runat="server" ClientIDMode="Static"
                                                    CssClass="table table-responsive table-hover table-bordered" OnRowCreated="gridCalendarioPago_RowCreated" OnRowDataBound="gridCalendarioPago_RowDataBound" AllowPaging="True" OnPageIndexChanging="gridCalendarioPago_PageIndexChanging" PageSize="15">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <td>
                                            ...
                                            <%--<asp:Button ID="btnAtras" CssClass="btn btn-default pull-left" runat="server" Text=" < Volver Atr&aacute;s" OnClientClick="return Dialogo();" OnClick="btnAtras_Click" />--%>
                                        </td>
                                            ...
                                            <dx:ASPxGridView ID="gvCalendarioPago" runat="server" ClientInstanceName="gvCalendarioPago" OnPageIndexChanged="gvCalendarioPago_PageIndexChanged" Width="100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataTextColumn FieldName="MontoCuota" Caption="Valor Cuota" HeaderStyle-Wrap="True" VisibleIndex="6" CellStyle-HorizontalAlign="Center" ShowInCustomizationForm="true"
                                                        PropertiesTextEdit-MaxLength="12" PropertiesTextEdit-ValidationSettings-RequiredField-IsRequired="true" PropertiesTextEdit-ClientSideEvents-KeyPress="function(s,e){ esNumero(s,e);}"
                            ...
                            <dx:PopupControlContentControl ID="PopupControlContentControl1">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            <%--ClientSideEvents-KeyUp="function(s,e){ formato(s,e);}"  LostFocus  ClientSideEvents-KeyPress="function(s,e){ esNumero(s,e);}" ClientSideEvents-LostFocus="function(s,e){ formatoDecimal(s,e);}"--%>
                                            <dx:ASPxTextBox ID="txtCapitalInicial" runat="server" ClientInstanceName="txtCapitalInicial" Width="100%" ValidationSettings-ValidationGroup="ValidarExcel"
                                                MaxLength="15" NullText="Ingrese Capital Inicial" ClientSideEvents-LostFocus="function(s,e){ formatoDecimal(s,e);}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <dx:ASPxComboBox ID="OrigenPagoFila" runat="server" ValueType="System.String" ClientInstanceName="OrigenPagoFila" CssClass="form-control" Width="100%"
                                                    DataSourceID="dsOrigenPago" ValueField="IdOrigenPago" TextField="DescPago" NullText="Seleccione" ValidationSettings-ValidationGroup="ValidarFila">
                                                    <ValidationSettings>
                                                        <RequiredField IsRequired="True" />
                                                    </ValidationSettings>
                                                </dx:ASPxComboBox>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <dx:ASPxTextBox ID="txtCertificadoMasivo" runat="server" ClientInstanceName="txtCertificadoMasivo" Width="100%" ValidationSettings-ValidationGroup="ValidarMasivo"
                                                    MaxLength="6" NullText="Ingrese N° Certificado" ClientSideEvents-LostFocus="buscarCertificado" CssClass="form-control">
                                                    <ValidationSettings>
                                                        <RequiredField IsRequired="True" />
                                                    </ValidationSettings>
                                                </dx:ASPxTextBox>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <dx:ASPxComboBox ID="OrigenPagoMasivo" runat="server" ValueType="System.String" ClientInstanceName="OrigenPagoMasivo" CssClass="form-control" Width="100%"
                                                    DataSourceID="dsOrigenPago" ValueField="IdOrigenPago" TextField="DescPago" NullText="Seleccione" ValidationSettings-ValidationGroup="ValidarMasivo">
                                                    <ValidationSettings>
                                                        <RequiredField IsRequired="True" />
                                                    </ValidationSettings>
                                                </dx:ASPxComboBox>
    ...
    <asp:SqlDataSource runat="server" ID="dsOrigenPago" ConnectionString="<%$ ConnectionStrings:DACConnectionString %>" SelectCommand="SELECT * FROM CP_OrigenPago where habilitado = 1" SelectCommandType="Text"></asp:SqlDataSource>
</div>
