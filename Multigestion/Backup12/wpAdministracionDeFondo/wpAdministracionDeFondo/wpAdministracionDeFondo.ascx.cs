...
namespace MultiOperacion.wpAdministracionDeFondo.wpAdministracionDeFondo
{
    ...
    public partial class wpAdministracionDeFondo : WebPart
    {
        ...
        protected void gvDetalleMov_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            ...
            try
            {
                ...
                if (idTipoMov != null && idConceptoPago != null && idDetallePago != null)
                    modificar = LN.InsertarModificaFondos(IdAdministracionFondo, "", 0, Convert.ToInt32(idTipoMov.ToString()), "", Convert.ToInt32(idConceptoPago.ToString()), "", Convert.ToInt32(idDetallePago.ToString()), "", Convert.ToDateTime(FechaMov), util.GetValorDouble(montoMov.Trim()), util.ObtenerValor(app2.CurrentUser.Name), 2, comentario.Trim(), null);
        ...
        protected void gvDetalleMov_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            if (result != null)
                insert = LN.InsertarModificaFondos(null, result[0]["NCertificado"].ToString().Trim(), Convert.ToInt32(result[0]["IdOperacion"]), Convert.ToInt32(idTipoMov), "", Convert.ToInt32(idConceptoPago), "", Convert.ToInt32(idDetallePago), "", Convert.ToDateTime(FechaMov), util.GetValorDouble(montoMov), util.ObtenerValor(app2.CurrentUser.Name), 1, comentario.ToString(), null);
