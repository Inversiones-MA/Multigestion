        ...
        protected void ResultadosBusquedaOperaciones_DataBound(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i <= ResultadosBusquedaOperaciones.Rows.Count - 1; i++)
            {
                ...
                if (System.Web.HttpUtility.HtmlDecode(ResultadosBusquedaOperaciones.Rows[i].Cells[12].Text) != " ")
                {
                    ...
                    //Convert.ToDecimal(a).ToString("N3", CultureInfo.CreateSpecificCulture("es-ES"));
                    ...
                    //Convert.ToDecimal(b).ToString("N3", CultureInfo.CreateSpecificCulture("es-ES"));
                ...
                if (System.Web.HttpUtility.HtmlDecode(ResultadosBusquedaOperaciones.Rows[i].Cells[21].Text) != " " || System.Web.HttpUtility.HtmlDecode(ResultadosBusquedaOperaciones.Rows[i].Cells[21].Text) != "")
                {
                        ...
                        && double.Parse((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoDeudaTotal") as TextBox).Text.ToString().Replace(".", "").Replace(",", ".")) > 0)
                    {
                        ...
                        //var a = Convert.ToDecimal(TotalGarantiasFogape / (txtMontoVigente * 100)).ToString("N3", CultureInfo.CreateSpecificCulture("es-ES"));
                        //var b = util.formatearNumero((((ResultadosBusquedaOperaciones.Rows[i].FindControl("TotalGarantiasFogape") as TextBox).Text.Trim().GetValorDouble() / ((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoVigente") as TextBox).Text.Trim().GetValorDouble())) * 100), 3);
                        //var c = Convert.ToDecimal((double.Parse((ResultadosBusquedaOperaciones.Rows[i].FindControl("TotalGarantiasFogape") as TextBox).Text.ToString().Replace(".", "").Replace(",", ".")) / double.Parse((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoVigente") as TextBox).Text.ToString().Replace(".", "").Replace(",", "."))) * 100).ToString("N3", CultureInfo.CreateSpecificCulture("es-ES"));
                        if ((ResultadosBusquedaOperaciones.Rows[i].FindControl("txtMontoVigente") as TextBox).Text.Trim().GetValorDouble() <= 0)
