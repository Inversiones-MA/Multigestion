...
<script type="text/javascript">
    ...
    function CalculoTotalGarantias(IDgridOperaciones, cadenaGrid, cadena, montoVigente) {
        ...
        var MontoVigente = parseFloat((document.getElementById(cadenaGrid + '_txtMontoVigente').value).replace(/\./g, '').replace(/\,/g, '.'));
        var dd = parseFloat((document.getElementById(cadenaGrid + '_txtMontoDeudaTotal').value).replace(/\./g, '').replace(/\,/g, '.'));
        if (isNaN(MontoVigente) || MontoVigente == '')
            MontoVigente = 0;
        ...
        if (MontoVigente != 0 || MontoVigente != '' || (valIngresadoH + valIngresadoP + valIngresadoO) != 0) {
            if (MontoVigente == 0) {
                document.getElementById(cadenaGrid + '_txtCobertura').value = (((valIngresadoH + valIngresadoP + valIngresadoO) / parseFloat((document.getElementById(cadenaGrid + '_txtMontoDeudaTotal').value).replace(/\./g, '').replace(/\,/g, '.'))) * 100).toFixed(3).replace(/\./g, ',') + '%';
            }
            else {
        ...
        if (MontoVigente != 0 || MontoVigente != '' || (valIngresadoH + valIngresadoP + valIngresadoO + valIngresadoF) != 0) {
            if (MontoVigente == 0) {
                document.getElementById(cadenaGrid + '_txtCoberturaFogape').value = (((valIngresadoH + valIngresadoP + valIngresadoO + valIngresadoF) / parseFloat((document.getElementById(cadenaGrid + '_txtMontoDeudaTotal').value).replace(/\./g, '').replace(/\,/g, '.'))) * 100).toFixed(3).replace(/\./g, ',') + '%';
            }
            else {
    ...
    function CalculosTotales(IDgridOperaciones, cadenaGrid, cadena, montoVigente) {
        ...
        if (acumGarantias != 0) {
            var tdeudaVigente = parseFloat(document.getElementById(IDgridOperaciones + '_ctl' + nro + '_txtTotalMontoVigente').value.replace(/\./g, '').replace(/\,/g, '.'));
            if (tdeudaVigente == 0) {
                var tdeudaTotal = parseFloat((document.getElementById(cadenaGrid + '_txtMontoDeudaTotal').value).replace(/\./g, '').replace(/\,/g, '.'));
                var b = formatNumber.new(parseFloat((acumGarantias / tdeudaTotal) * 100).toFixed(3));
                document.getElementById(IDgridOperaciones + '_ctl' + nro + '_txtTotalCobertura').value = formatNumber.new(parseFloat((acumGarantias / tdeudaTotal) * 100).toFixed(3));
            }
            else
                                        ...
                                        <td>
                                            <div class="card-box">
                                                <div class="table-responsive">
                                                    <asp:GridView ID="ResultadosBusquedaGarantias" runat="server" Width="100%" Font-Size="Smaller" CssClass="table table-bordered table-hover" GridLines="Horizontal"
                                                        ...
                                                        <asp:GridView ID="ResultadosBusquedaOperaciones" runat="server" Width="100%"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Monto Vigente UF">
                                                                    <ItemTemplate>
                                                                        <br />
                                                                        <asp:TextBox ID="txtMontoVigente" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalMontoVigente" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Monto Siniestrado">
                                                                    <ItemTemplate>
                                                                        <br />
                                                                        <asp:TextBox ID="txtMontoSiniestrado" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalMontoSiniestrado" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Monto Recuperado">
                                                                    <ItemTemplate>
                                                                        <br />
                                                                        <asp:TextBox ID="txtMontoRecuperado" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalMontoRecuperado" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Deuda Total">
                                                                    <ItemTemplate>
                                                                        <br />
                                                                        <asp:TextBox ID="txtMontoDeudaTotal" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalMontoDeudaTotal" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="% Deuda">
                                                                    <ItemTemplate>
                                                                        <br />
                                                                        <asp:TextBox ID="txtDeuda" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalDeuda" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Hipotecas UF">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtPorHipoteca" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                        <asp:TextBox ID="txtValHipoteca" runat="server" MaxLength="16" Width="80" CssClass="form-control input10px" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalHipotecas" runat="server" CssClass="input10px" Width="80" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Prendas UF">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtPorPrendas" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                        <asp:TextBox ID="txtValPrendas" runat="server" CssClass="form-control input10px" MaxLength="16" Width="80"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalPrendas" runat="server" CssClass="input10px" Width="80" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Otros UF">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtPorOtros" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                        <asp:TextBox ID="txtValOtros" runat="server" MaxLength="16" Width="80" CssClass="form-control input10px"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalOtros" runat="server" CssClass="input10px" Width="80" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Total Garantías UF">
                                                                    <ItemTemplate>
                                                                        <br />
                                                                        <asp:TextBox ID="TotalGarantias" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalGarantias" runat="server" CssClass="input10px" Width="80" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="% Cobertura">
                                                                    <ItemTemplate>
                                                                        <br />
                                                                        <asp:TextBox ID="txtCobertura" runat="server" CssClass="input10px" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalCobertura" CssClass="input10px" runat="server" Width="80" BorderColor="Transparent" BackColor="Transparent"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Fogape">
                                                                    <ItemTemplate>
                                                                        <br />
                                                                        <asp:TextBox ID="txtFogape" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalFogape" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Total Garantías UF con Fogape">
                                                                    <ItemTemplate>
                                                                        <br />
                                                                        <asp:TextBox ID="TotalGarantiasFogape" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalGarantiasFogape" runat="server" CssClass="input10px" Width="80" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="% Cobertura con Fogape">
                                                                    <ItemTemplate>
                                                                        <br />
                                                                        <asp:TextBox ID="txtCoberturaFogape" runat="server" CssClass="input10px" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent" Width="80"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:TextBox ID="txtTotalCoberturaFogape" CssClass="input10px" runat="server" Width="80" ReadOnly="true" BorderColor="Transparent" BackColor="Transparent"></asp:TextBox>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                    ...
                    <table style="width: 95%">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Button ID="btnCancel" runat="server" Text="Imprimir" OnClick="btnImprimir_Click" CssClass="btn btn-warning pull-right" OnClientClick="return Dialogo();" />
