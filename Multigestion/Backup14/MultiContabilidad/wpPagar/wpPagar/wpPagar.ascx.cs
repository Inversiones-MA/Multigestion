        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (txt_Factura.Text.ToString() != "")
            {
                ...
                if (Ln.InsertarActualizarPagoFacturacion(objresumen.idEmpresa.ToString(), objresumen.idOperacion.ToString(),
                    ...
                    if (Ln.InsertarActualizarEstadoPagar(objresumen.idEmpresa.ToString(), objresumen.idOperacion.ToString(),
                    ...
                    {
                        Ln.ActualizarEstado(objresumen.idOperacion.ToString(), "8", "Cierre", "26", "Pagado", "5", "Cursado", "Operaciones");
                        ocultarDiv();
