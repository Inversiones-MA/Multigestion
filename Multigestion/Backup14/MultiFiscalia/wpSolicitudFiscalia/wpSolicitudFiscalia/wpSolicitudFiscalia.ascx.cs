...
namespace MultiFiscalia.wpSolicitudFiscalia.wpSolicitudFiscalia
{
    ...
    public partial class wpSolicitudFiscalia : WebPart
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            Boolean exito = true;
            if (objresumen.area.Trim() == "Comercial" && tbServiciosGarantia1.Rows.Count > 0 && tbServiciosOperaciones1.Rows.Count > 0)
            {
                {
        ...
        {
            util.CargaDDL(ddlGarantias, dtServiciosGarantia, "Nro. Garantía", "Nro. Garantía");
        }
        ...
        {
            LogicaNegocio Ln = new LogicaNegocio();
            DataTable dt = Ln.ListarServiciosOperacion();
