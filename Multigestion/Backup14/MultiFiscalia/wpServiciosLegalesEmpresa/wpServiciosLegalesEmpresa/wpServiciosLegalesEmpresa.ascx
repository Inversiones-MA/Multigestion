...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpServiciosLegalesEmpresa.ascx.cs" Inherits="MultiFiscalia.wpServiciosLegalesEmpresa.wpServiciosLegalesEmpresa.wpServiciosLegalesEmpresa" %>
...
<div class="row marginInicio">
    <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Servicios Legales Empresa
            </li>
        </ol>
    </div>
</div>
 ...
 <div class="row">
    <div class="col-md-12">
        <div class="alert alert-gray">
            <p><strong>Empresa: <asp:Label ID="lbEmpresa" runat="server" Text=""></asp:Label></strong> / <asp:Label ID="lbRut" runat="server" Text=""></asp:Label> / Negocio: <asp:Label ID="lbOperacion" runat="server" Text=""></asp:Label> / Ejecutivo: <asp:Label ID="LblEjecutivo" runat="server" Text=""></asp:Label> / N° Certificado: <asp:Label ID="lblNCertificado" runat="server" Text=""></asp:Label></p>
        </div>
    </div>
</div>
            ...
            <div class="tab-pane active" id="tab1">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <asp:Label ID="lbOperacion1" class="form-control" runat="server"></asp:Label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <td>
                                    <div class="card-box">
                                        <div class="table-responsive">
                                            <asp:GridView ID="tbServiciosOperaciones1" runat="server" GridLines="Horizontal" class="table table-bordered table-hover"
                                                RowHeaderColumn="0" ShowHeaderWhenEmpty="True" PageSize="10" ShowFooter="True" AutoGenerateColumns="False" OnDataBound="tbServiciosOperaciones1_DataBound" OnRowCreated="tbServiciosOperaciones1_RowCreated">
                                                <Columns>
                                                    <asp:TemplateField>
                                        ...
                                        <div class="card-box">
                                            <div class="table-responsive">
                                                <asp:GridView ID="gridDocumentos" runat="server" GridLines="Horizontal"
                                                    CssClass="table table-bordered table-hover" RowHeaderColumn="0"
                ...
                <table style="width:100%">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" OnClick="btnAtras_Click" CssClass="btn btn-primary pull-right" OnClientClick="return Dialogo();" Visible="false" />

                             <asp:Button ID="btnFinalizar" runat="server" Text="Finalizar" OnClick="btnFinalizar_Click" CssClass="btn btn-warning pull-right" OnClientClick="return Dialogo();" />

                            <asp:Button CssClass="btn btn-primary btn-success pull-right" ID="btnGuardar" runat="server" Text="Guardar" OnClick="btnGuardar_Click" OnClientClick="return Dialogo();" Visible="false" />
                        </td>
                    </tr>
                </table>
            </div>
