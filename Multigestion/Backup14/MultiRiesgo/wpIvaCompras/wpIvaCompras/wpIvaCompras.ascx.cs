    ...
    public partial class wpIvaCompras : WebPart
    {
        ...
        protected void btnFinalizarAct_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["IDIVACOMPRAS"] != null)
            {
                ...
                {
                    exito = Ln.finalizarIvaCOMPRAS(objresumen.idEmpresa.ToString(), ViewState["IDIVACOMPRAS"].ToString(), xmlData, Constantes.RIESGO.VALIDACION, (DateTime.Now.Year).ToString());
                    pnFormularioAct.Enabled = false;
                    llenargrid();
                }
                else
        ...
        protected void btnFinalizar1_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["IDIVACOMPRAS"] != null)
            {
                ...
                if (mensaje == string.Empty)
                {
                    exito = Ln.finalizarIvaCOMPRAS(objresumen.idEmpresa.ToString(), ViewState["IDIVACOMPRAS"].ToString(), xmlData, Constantes.RIESGO.VALIDACION, (DateTime.Now.Year - 1).ToString());
                    pnFormularioAct.Enabled = false;
                    llenargrid();
                }
                else
        ...
        protected void btnFinalizar2_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["IDIVACOMPRAS"] != null)
            {
                ...
                if (mensaje == string.Empty)
                {
                    exito = Ln.finalizarIvaCOMPRAS(objresumen.idEmpresa.ToString(), ViewState["IDIVACOMPRAS"].ToString(), xmlData, Constantes.RIESGO.VALIDACION, (DateTime.Now.Year - 2).ToString());
                    pnFormularioAct.Enabled = false;
                    llenargrid();
                }
                else
        ...
        protected void btnFinalizar3_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["IDIVACOMPRAS"] != null)
            {
                ...
                if (mensaje == string.Empty)
                {
                    exito = Ln.finalizarIvaCOMPRAS(objresumen.idEmpresa.ToString(), ViewState["IDIVACOMPRAS"].ToString(), xmlData, Constantes.RIESGO.VALIDACION, (DateTime.Now.Year - 3).ToString());
                    pnFormularioAct.Enabled = false;
                    llenargrid();
                }
                else
        ...
        private void llenargrid()
        {
            ...
            ViewState["res1"] = Ln.ListarIVACompras(objresumen.idEmpresa, DateTime.Now.Year, Constantes.DOCUMENTOSCONTABLE.IVACOMPRAS);
            ViewState["res2"] = Ln.ListarIVACompras(objresumen.idEmpresa, DateTime.Now.Year - 1, Constantes.DOCUMENTOSCONTABLE.IVACOMPRAS);
            ViewState["res3"] = Ln.ListarIVACompras(objresumen.idEmpresa, DateTime.Now.Year - 2, Constantes.DOCUMENTOSCONTABLE.IVACOMPRAS);
            ViewState["res4"] = Ln.ListarIVACompras(objresumen.idEmpresa, DateTime.Now.Year - 3, Constantes.DOCUMENTOSCONTABLE.IVACOMPRAS);
        ...
        protected void guardarAct()
        {
            ...
            {
                exito = Ln.InsertarIvaCOMPRAS(objresumen.idEmpresa.ToString(), generarXML((DateTime.Now.Year).ToString(), ref gridIvaAct), (DateTime.Now.Year).ToString());
                if (exito)
                {
            ...
            {
                exito = Ln.ModificarIvaCOMPRAS(objresumen.idEmpresa.ToString(), ViewState["IDIVACOMPRAS"].ToString(), generarXML((DateTime.Now.Year).ToString(), ref gridIvaAct), (DateTime.Now.Year).ToString());
                if (exito)
                {
                    dvSuccess.Style.Add("display", "block");
        ...
        protected void guardar1()
        {
            ...
            if (ViewState["ACCION"].ToString() == Constantes.OPCION.INSERTAR)
            {
                exito = Ln.InsertarIvaCOMPRAS(objresumen.idEmpresa.ToString(), generarXML((DateTime.Now.Year - 1).ToString(), ref gridIva1), (DateTime.Now.Year - 1).ToString());
                if (exito)
                {
                    dvSuccess.Style.Add("display", "block");
                    lbSuccess.Text = Ln.buscarMensaje(Constantes.MENSAJES.EXITOINSETDOCCONTABLE);
            ...
            {
                exito = Ln.ModificarIvaCOMPRAS(objresumen.idEmpresa.ToString(), ViewState["IDIVACOMPRAS"].ToString(), generarXML((DateTime.Now.Year - 1).ToString(), ref gridIva1), (DateTime.Now.Year - 1).ToString());
                if (exito)
                {
                    dvSuccess.Style.Add("display", "block");
                    lbSuccess.Text = Ln.buscarMensaje(Constantes.MENSAJES.EXITOMODIFDOCCONTABLE);
        ...
        protected void guardar3()
        {
            ...
            if (ViewState["ACCION"].ToString() == Constantes.OPCION.INSERTAR)
            {
                exito = Ln.InsertarIvaCOMPRAS(objresumen.idEmpresa.ToString(), generarXML((DateTime.Now.Year - 2).ToString(), ref gridIva2), (DateTime.Now.Year - 2).ToString());
                if (exito)
                {
                    dvSuccess.Style.Add("display", "block");
                    lbSuccess.Text = Ln.buscarMensaje(Constantes.MENSAJES.EXITOINSETDOCCONTABLE);
            ...
            {
                exito = Ln.ModificarIvaCOMPRAS(objresumen.idEmpresa.ToString(), ViewState["IDIVACOMPRAS"].ToString(), generarXML((DateTime.Now.Year - 2).ToString(), ref gridIva2), (DateTime.Now.Year - 2).ToString());
                if (exito)
                {
                    dvSuccess.Style.Add("display", "block");
                    lbSuccess.Text = Ln.buscarMensaje(Constantes.MENSAJES.EXITOMODIFDOCCONTABLE);
        ...
        protected void guardar4()
        {
            ...
            if (ViewState["ACCION"].ToString() == Constantes.OPCION.INSERTAR)
            {
                exito = Ln.InsertarIvaCOMPRAS(objresumen.idEmpresa.ToString(), generarXML((DateTime.Now.Year - 3).ToString(), ref gridIva3), (DateTime.Now.Year - 3).ToString());
                if (exito)
                {
                    dvSuccess.Style.Add("display", "block");
                    lbSuccess.Text = Ln.buscarMensaje(Constantes.MENSAJES.EXITOINSETDOCCONTABLE);
            ...
            {
                exito = Ln.ModificarIvaCOMPRAS(objresumen.idEmpresa.ToString(), ViewState["IDIVACOMPRAS"].ToString(), generarXML((DateTime.Now.Year - 3).ToString(), ref gridIva3), (DateTime.Now.Year - 3).ToString());
                if (exito)
                {
                    dvSuccess.Style.Add("display", "block");
                    lbSuccess.Text = Ln.buscarMensaje(Constantes.MENSAJES.EXITOMODIFDOCCONTABLE);
