...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpIvaCompras.ascx.cs" Inherits="MultiRiesgo.wpIvaCompras.wpIvaCompras.wpIvaCompras" %>
                    ...
                    <div class="col-md-12">
                        <ul class="nav nav-tabs navtab-bg nav-justified">
                            <li id="liAct" runat="server"><a href="#panel-tab1" data-toggle="tab">
                                <asp:Label ID="lbLiAct" runat="server" Text="Compras"></asp:Label>
                            </a></li>
                            <li id="li1" runat="server"><a href="#panel-tab2" data-toggle="tab">
                                <asp:Label ID="lbLi1" runat="server" Text="Compras"></asp:Label>
                            </a></li>
                            <li id="li2" runat="server"><a href="#panel-tab3" data-toggle="tab">
                                <asp:Label ID="lbLi2" runat="server" Text="Compras"></asp:Label>
                            </a></li>
                            <li id="li3" runat="server"><a href="#panel-tab4" data-toggle="tab">
                                <asp:Label ID="lbLi3" runat="server" Text="Compras"></asp:Label>
                            </a></li>
                        </ul>
                    </div>
                </div>
                                                ...
                                                <div class="card-box">
                                                    <div class="table-responsive">
                                                        <asp:GridView class="table table-bordered table-hover" ID="gridIvaAct" runat="server"
                                                            ...
                                                            RowHeaderColumn="0" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False"
                                                            OnRowCreated="gridIvaAct_RowCreated" OnDataBound="gridIvaAct_DataBound" OnRowDataBound="gridIvaAct_RowDataBound">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Ene">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMes1" runat="server" class="form-control input10px" MaxLength="16" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="Feb">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMes2" runat="server" class="form-control input10px" MaxLength="16" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="Mar">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMes3" runat="server" class="form-control input10px" MaxLength="16" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="Abr">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMes4" runat="server" class="form-control input10px" MaxLength="16" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="May">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMes5" runat="server" class="form-control input10px" MaxLength="16" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="Jun">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMes6" runat="server" class="form-control input10px" MaxLength="16" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Jul">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMes7" runat="server" class="form-control input10px" MaxLength="16" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Agos">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMes8" runat="server" class="form-control input10px" MaxLength="16" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Sep">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMes9" runat="server" class="form-control input10px" MaxLength="16" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Oct">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMes10" runat="server" class="form-control input10px" MaxLength="16" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Nov">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMes11" runat="server" class="form-control input10px" MaxLength="16" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Dic">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtMes12" runat="server" class="form-control input10px" MaxLength="16" onKeyPress="return solonumerosN(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
