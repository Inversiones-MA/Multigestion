...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpListarRiesgo.ascx.cs" Inherits="MultiRiesgo.wpListarRiesgo.wpListarRiesgo.wpListarRiesgo" %>
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <asp:LinkButton ID="BtnBuscar" runat="server" CssClass="btn btn-default"><i class="fa fa-search"></i></asp:LinkButton>
                                </span>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
