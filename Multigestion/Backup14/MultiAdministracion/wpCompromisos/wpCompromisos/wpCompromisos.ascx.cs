    ...
    public partial class wpCompromisos : WebPart
    {
        ...
        protected void bt_Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (com.Trim() != "")
            {
                ...
                LogicaNegocio Ln = new LogicaNegocio();
                bool resGuardar = Ln.GuardarCompromiso(idOperacion, idEmpresa, ejecutivo, area, com, usuario, etapa, subetapa, null, 0);

                if (resGuardar)
                {
                    //mostar mensaje
                    lbSuccess.Text = "Se ha guardado correctamente un comentario.";
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            string Reporte = "Compromisos";

            byte[] archivo = new Reportes { }.GenerarReporteCompromisos(Reporte, datos, string.Empty, objresumen.idOperacion);
