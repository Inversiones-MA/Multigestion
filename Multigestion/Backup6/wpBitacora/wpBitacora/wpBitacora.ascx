...
<script type="text/javascript">
    ...
    function DescargarExcel() {
        //setTimeout(function () { OpenDlg(); }, 6000);
        var filtro = 'excel';
        var certificado = txtCertificado.GetText();
        var empresa = txtRazonSocial.GetText();
        var parametros = new Array(filtro, certificado, empresa);
...
<div id="dvFormulario" runat="server">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <dx:ASPxTextBox ID="txtCertificado" runat="server" ClientInstanceName="txtCertificado" CssClass="form-control" MaxLength="6" Width="100%" ClientIDMode="Static"></dx:ASPxTextBox>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                        ...
                        <td>
                            <dx:ASPxGridView ID="gvBitacora" runat="server" ClientInstanceName="gvBitacora" Width="100%" KeyFieldName="Id" ClientIDMode="Static"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataComboBoxColumn FieldName="IdBanco" Caption="Acreedor" HeaderStyle-Wrap="True" VisibleIndex="5" CellStyle-HorizontalAlign="Center" ShowInCustomizationForm="true">
                                        <HeaderStyle HorizontalAlign="Center" Wrap="True" Font-Bold="true" />
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="Comentario" Caption="Comentario" HeaderStyle-Wrap="True" VisibleIndex="10" CellStyle-HorizontalAlign="Center" Width="15%">
                                        <HeaderStyle HorizontalAlign="Center" Wrap="True" Font-Bold="true" />
                                        <DataItemTemplate>
    ...
    <dx:ASPxPopupControl ID="pcCargarMasivo" runat="server" ClientInstanceName="pcCargarMasivo" CloseAction="CloseButton" ClientIDMode="Static"
        ...
        HeaderText="Carga masiva" HeaderStyle-Font-Bold="true"
        AllowDragging="True"
                    ...
                    <div class="col-md-12">
                        <div class="col-md-4">
                            <dx:ASPxUploadControl ID="UpSubirMasivo" ShowUploadButton="false" runat="server" ClientInstanceName="UpSubirMasivo" UploadMode="Standard"
                                ShowProgressPanel="false" Theme="MetropolisBlue" FileUploadMode="OnPageLoad" ClientIDMode="Static" EncodeHtml="false"
                        ...
                        <tr>
                            <td>
                                <dx:ASPxGridView ID="gvPreCargaMasivo" runat="server" ClientInstanceName="gvPreCargaMasivo" OnPageIndexChanged="gvPreCargaMasivo_PageIndexChanged" Width="100%"
                                    OnCustomCallback="gvPreCargaMasivo_CustomCallback" ClientSideEvents-EndCallback="EndgvPreCargaMasivo"
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="Motivo" Caption="Motivo" HeaderStyle-Wrap="True" VisibleIndex="2" CellStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" Font-Bold="true" />
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn FieldName="Causa" Caption="Causa" HeaderStyle-Wrap="True" VisibleIndex="3" CellStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" Font-Bold="true" />
                                        </dx:GridViewDataTextColumn>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="FechaPago" Caption="Fecha Pago" HeaderStyle-Wrap="True" VisibleIndex="5" CellStyle-HorizontalAlign="Center" PropertiesTextEdit-DisplayFormatString="C2">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" Font-Bold="true" />
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn FieldName="Acreedor" Caption="Acreedor" HeaderStyle-Wrap="True" VisibleIndex="6" CellStyle-HorizontalAlign="Center" PropertiesTextEdit-DisplayFormatString="C2">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" Font-Bold="true" />
                                            <PropertiesTextEdit EncodeHtml="false"/>
                                        </dx:GridViewDataTextColumn>

                                        <dx:GridViewDataTextColumn FieldName="NDocumento" Caption="N° Documento" HeaderStyle-Wrap="True" VisibleIndex="7" CellStyle-HorizontalAlign="Center" PropertiesTextEdit-DisplayFormatString="C2">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" Font-Bold="true" />
                                        </dx:GridViewDataTextColumn>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="Comentario" Caption="Comentario" HeaderStyle-Wrap="True" VisibleIndex="9" CellStyle-HorizontalAlign="Center">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="True" Font-Bold="true" />
                                            <EditItemTemplate>
                                                <dx:ASPxMemo runat="server" ID="txtComentario" ClientIDMode="Static" Rows="3" MaxLength="250" Width="100%" ClientInstanceName="txtComentario"
