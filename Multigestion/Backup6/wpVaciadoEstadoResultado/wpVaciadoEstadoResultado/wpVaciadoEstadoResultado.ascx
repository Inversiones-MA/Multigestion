...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpVaciadoEstadoResultado.ascx.cs" Inherits="MultiRiesgo.wpVaciadoEstadoResultado.wpVaciadoEstadoResultado.wpVaciadoEstadoResultado" %>
...
<div class="row marginInicio">
    <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Estado de Resultado
            </li>
        </ol>
    </div>
</div>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td class="auto-style1">
                                                    <asp:Button ID="btnGuardari" CssClass="btn btn-primary btn-info pull-right" runat="server" Text="Guardar" OnClick="btnGuardar_Click" OnClientClick="return Dialogo();" />
								    ...
								    <td>
                                        <div class="card-box">
                                            <div class="table-responsive">
                                                <asp:GridView class="table table-responsive table-hover table-bordered" ID="ResultadosBusqueda" runat="server" GridLines="Horizontal" OnRowCreated="ResultadosBusqueda_RowCreated" OnRowDataBound="ResultadosBusqueda_RowDataBound" RowHeaderColumn="0" ShowHeaderWhenEmpty="True" OnDataBound="ResultadosBusqueda_DataBound" OnSelectedIndexChanged="ResultadosBusqueda_SelectedIndexChanged" AutoGenerateColumns="False">
                                                ...
                                                <asp:DropDownList ID="ddlRequerido3" runat="server">
                                                    ...
                                                    <asp:ListItem Text="No" Value="0" Selected="True"></asp:ListItem>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtAnio1" runat="server" Width="80" MaxLength="16" onKeyPress="return solonumerosN(event)" TabIndex="100"></asp:TextBox>
                                                ...
                                                <asp:DropDownList ID="ddlRequerido2" runat="server">
                                                    ...
                                                    <asp:ListItem Text="No" Value="0" Selected="True"></asp:ListItem>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtAnio2" runat="server" Width="80" MaxLength="16" onKeyPress="return solonumerosN(event)" TabIndex="200"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                ...
                                                <asp:DropDownList ID="ddlRequerido1" runat="server">
                                                    ...
                                                    <asp:ListItem Text="No" Value="0" Selected="True"></asp:ListItem>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtAnio3" runat="server" Width="80" MaxLength="16" onKeyPress="return solonumerosN(event)" TabIndex="300"></asp:TextBox>
                                                            </ItemTemplate>
                                                ...
                                                <asp:DropDownList ID="ddlRequeridoActual" runat="server">
                                                    ...
                                                    <asp:ListItem Text="No" Value="0" Selected="True"></asp:ListItem>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtAnioA" runat="server" Width="80" MaxLength="16" onKeyPress="return solonumerosN(event)" TabIndex="400"></asp:TextBox>
                                                            </ItemTemplate>
								...
								<div class="card-box">
									<div class="row">
                                        ...
                                        <div class="col-md-10 col-sm-10" >
                                            <asp:TextBox ID="txtComentario" runat="server" style="width:100%;" class="form-control" TextMode="MultiLine"></asp:TextBox>
                                        </div>
