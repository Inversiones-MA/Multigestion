...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpCftFiscaliaExpress.ascx.cs" Inherits="MultiFiscalia.wpCftFiscaliaExpress.wpCftFiscaliaExpress.wpCftFiscaliaExpress" %>
        ...
        <div class="card-box">
            <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <asp:DropDownList ID="ddlEdoFiscalia" CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlEdoFiscalia_SelectedIndexChanged">
                            <asp:ListItem Value="-1">Seleccione</asp:ListItem>
                            <asp:ListItem Value="17">Aprobación Servicios</asp:ListItem>
                            <asp:ListItem Value="18">Confección Contratos</asp:ListItem>
                            <asp:ListItem Value="19">Aprobación Fiscalía</asp:ListItem>
                            <asp:ListItem Value="20">Cierre Legal</asp:ListItem>
                        </asp:DropDownList>
                    </div>
